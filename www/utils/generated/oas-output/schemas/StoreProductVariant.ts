 ...
 *     description: Whether AcmeKit manages the variant's inventory. If disabled, the variant is always considered in stock.
 *     externalDocs:
 *       url: https://docs.acmekit.com/resources/storefront-development/products/inventory
