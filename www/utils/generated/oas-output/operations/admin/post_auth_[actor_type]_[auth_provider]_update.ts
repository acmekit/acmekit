 ...
 * description: Reset an admin user's password using a reset-password token generated with the [Generate Reset Password Token API route](https://docs.acmekit.com/api/admin#auth_postactor_typeauth_providerresetpassword). You pass the token as a bearer token in the request's Authorization header.
 * externalDocs:
 *   url: https://docs.acmekit.com/resources/commerce-modules/auth/authentication-route#reset-password-route
