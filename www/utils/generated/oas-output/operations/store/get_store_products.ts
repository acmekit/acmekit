 ...
 * externalDocs:
 *   url: https://docs.acmekit.com/resources/storefront-development/products/price
 ...
 *       description: Filter by a collection's ID to retrieve the products in it.
 *       externalDocs:
 *         url: https://docs.acmekit.com/resources/storefront-development/products/collections/products
 ...
 *       description: The ID of the region the products are being viewed from. This is required if you're retrieving product variant prices with taxes.
 *       externalDocs:
 *         url: https://docs.acmekit.com/resources/storefront-development/products/price/examples/tax-price
