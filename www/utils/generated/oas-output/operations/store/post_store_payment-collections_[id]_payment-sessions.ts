 ...
 * 
 *   In cases where you want to create a payment session for a payment collection with an amount of `0`, you can use the Manual System Payment Provider instead of third-party payment providers. The Manual System Payment Provider is built into AcmeKit and allows you to create payment sessions without interacting with an external payment provider.
 * 
 *   Make sure to configure the Manual System Payment Provider in your store's region. Learn more in the [Manage Region](https://docs.acmekit.com/user-guide/settings/regions#edit-region-details) user guide.
 * externalDocs:
 *   url: https://docs.acmekit.com/resources/storefront-development/checkout/payment
 ...
 *     in: header
 *     description: Publishable API Key created in the AcmeKit Admin.
 *     required: true
 *     schema:
 *       type: string
 *       externalDocs:
 *         url: https://docs.acmekit.com/api/store#publishable-api-key
 *   - name: x-acmekit-locale
 *     in: header
 ...
 *       example: en-US
 *       externalDocs:
 *         url: https://docs.acmekit.com/resources/commerce-modules/translation/storefront
