 ...
 * externalDocs:
 *   url: https://docs.acmekit.com/resources/storefront-development/customers/login#1-using-a-jwt-token
 ...
 * 
 *           For the Google and GitHub authentication providers, you can pass `callback_url` to indicate the URL in the frontend that the customer should be redirected to after completing their authentication. This will override the provider's `callbackUrl` configurations in `acmekit-config.ts`.
 * x-codeSamples:
 *   - lang: JavaScript
 *     label: JS SDK
 *     source: |-
