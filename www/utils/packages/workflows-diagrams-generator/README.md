...
> Note: This tool is a beta tool created to generate diagrams that can be used in the AcmeKit documentation.
...
Removes AcmeKit's default theming from the outputted diagram. Note that AcmeKit's theme doesn't support dark mode.
