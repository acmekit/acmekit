...
/**
 * A class that holds common AcmeKit patterns and acts as a knowledge base for possible summaries/examples/general templates.
 */
class KnowledgeBaseFactory {
  ...
  /**
   * This method retrieves plural configuration for AcmeKit service's functions.
   *
