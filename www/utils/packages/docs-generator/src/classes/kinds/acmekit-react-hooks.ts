...
} from "../../utils/acmekit-react-utils.js"

/**
 * Docblock generate for acmekit-react hooks. Since hooks are essentially functions,
 * it extends the {@link FunctionKindGenerator} class.
 */
class AcmeKitReactHooksKindGenerator extends FunctionKindGenerator {
  public name = "acmekit-react"
  /**
  ...
  /**
   * Retrieves the docblock of the acmekit-react hook or mutation.
   *
...
export default AcmeKitReactHooksKindGenerator
