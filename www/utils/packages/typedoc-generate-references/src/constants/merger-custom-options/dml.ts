...
const dmlOptions: FormattingOptionsType = {
  ...
  "^modules/dml/page\\.mdx": {
    reflectionDescription:
      "This section of the documentation to AcmeKit's Data Model Language (DML). Refer to it for all methods and options relevant to creating data models.",
    reflectionGroups: {
      Classes: false,
      Variables: false,
      Properties: false,
    ...
    reflectionTitle: {
      fullReplacement: "AcmeKit Data Model Language Reference",
    },
    hideTocHeaders: true,
  },
  "^dml/.*define": {
