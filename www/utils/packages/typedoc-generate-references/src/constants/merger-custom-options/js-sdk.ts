...
const jsSdkOptions: FormattingOptionsType = {
  ...
  "^js_sdk/store/classes/.*Store": {
    ...
    reflectionDescription:
      "The `sdk.store` class provides methods to send requests to AcmeKit's Store API routes.",
    reflectionTitle: {
  ...
  "^js_sdk/store/Store/properties/": {
    ...
    reflectionDescription:
      "This documentation provides a reference to the `sdk.store.{{alias}}` set of methods used to send requests to AcmeKit's Store API routes.",
    sections: {
      ...baseSectionsOptions,
      member_declaration_title: false,
  ...
  "^js_sdk/admin/classes/.*Admin": {
    ...
    reflectionDescription:
      "The `sdk.admin` class provides methods to send requests to AcmeKit's Admin API routes.",
    reflectionTitle: {
  ...
  "^js_sdk/admin/Admin/properties/": {
    ...
    reflectionDescription:
      "This documentation provides a reference to the `sdk.admin.{{alias}}` set of methods used to send requests to AcmeKit's Admin API routes.",
    sections: {
      ...baseSectionsOptions,
      member_declaration_title: false,
      member_declaration_children: true,
  ...
  "^js_sdk/auth/Auth/methods/": {
    ...
    reflectionDescription:
      "This documentation provides a reference to the `sdk.auth.{{alias}}` method used to send requests to AcmeKit's Authentication API routes. It can be used for admin users, customers, or custom actor types.",
  },
}
