...
The Cache Module is deprecated starting from [AcmeKit v2.11.0](https://github.com/acmekit/acmekit/releases/tag/v2.11.0). [Use the Caching Module](https://docs.acmekit.com/resources/infrastructure-modules/caching) instead.
...
In your workflow's step, you can resolve the Cache Module's service from the AcmeKit container:
...
This will resolve the service of the configured Cache Module, which is the [In-Memory Cache Module](https://docs.acmekit.com/resources/infrastructure-modules/cache/in-memory) by default.
