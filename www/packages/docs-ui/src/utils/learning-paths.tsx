...
const paths: LearningPathType[] = [
    ...
    steps: [
      {
        ...
        description:
          "Create a Next.js Starter Template and connect it to your AcmeKit backend.",
        path: "#",
      },
      {
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        descriptionJSX: (
          <>
            Add a payment provider to your AcmeKit backend. You can choose to
            install a plugin or{" "}
      ...
      },
      {
        ...
        path: "/starters/nextjs-acmekit-starter",
        descriptionJSX: (
          <>
      ...
      },
      {
        ...
        descriptionJSX: (
          <>
            ...
            handles creating the subscription in AcmeKit.
          </>
        ),
        path: "/development/events/create-subscriber",
      },
  ...
  },
  {
    ...
    description:
      "Utilize AcmeKit's features and customization capabilities to build a B2B store.",
    steps: [
      {
        ...
        descriptionJSX: (
          <>
            ...
            wholesale products.
            <br />
            You can either use the AcmeKit admin, or the{" "}
      ...
      },
      {
        ...
        descriptionJSX: (
          <>
            ...
            <br />
            You can use the AcmeKit admin to add the products. Other alternatives
            are:
            <ul>
              <li>
              ...
              <li>
                <Link href="/user-guide/products/import">
                  Import Products Using AcmeKit Admin
                </Link>
              </li>
              <li>
      ...
      },
      {
        ...
        descriptionJSX: (
          <>
            ...
            <br />
            You can use the AcmeKit admin to add the price list. Other
            alternatives are:
            <ul>
              <li>
              ...
              <li>
                <Link href="/user-guide/price-lists/import">
                  Import Prices Using AcmeKit Admin
                </Link>
              </li>
              <li>
      ...
      },
      {
        ...
        descriptionJSX: (
          <>
            ...
            recipe.
            <br />
            AcmeKit can be customized to add custom entities, API Routes,
            services, and more.
            <br />
            You can find additional development resources in the{" "}
            <Link href="/development/overview">AcmeKit development section</Link>
            .
          </>
        ),
      },
  ...
  },
  {
    ...
    description:
      "Use AcmeKit’s architecture and functionalities to integrate third-party systems and build flows around them.",
    steps: [
      {
        ...
        descriptionJSX: (
          <>
            AcmeKit’s Services let you implement a client that connects and
      ...
      },
      {
        ...
        descriptionJSX: (
          <>
            With AcmeKit’s workflows, you can build flows with steps that may
      ...
      },
      {
        ...
        descriptionJSX: (
          <>
            ...
            <br />
            <br />
            Webhook listeners can be created in AcmeKit using API Routes.
          </>
        ),
      },
    ],
