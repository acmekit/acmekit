    ...
    <Tooltip
      render={() => (
        <span className="flex gap-[5px] items-center">
          <Kbd className="bg-acmekit-bg-field-component border-acmekit-border-strong w-[18px] h-[18px] inline-block">
            {osShortcut}
          </Kbd>
          <Kbd className="bg-acmekit-bg-field-component border-acmekit-border-strong w-[18px] h-[18px] inline-block">
            i
    ...
    >
      ...
      >
        <Image
          ...
          alt="AI Assistant"
        />
        <span className="hidden md:inline-block text-acmekit-fg-subtle">
          Ask AI
        </span>
      </Button>
    </Tooltip>
