...
vi.mock("@/providers/SiteConfig", () => ({
  useSiteConfig: () => ({
    config: {
      baseUrl: "https://docs.acmekit.com",
    },
  }),
}))
...
describe("rendering", () => {
  test("renders suggestions", () => {
    ...
    expect(container).toHaveTextContent("What is AcmeKit?")
    ...
    expect(container).toHaveTextContent("AcmeKit MCP server")
  })
})
