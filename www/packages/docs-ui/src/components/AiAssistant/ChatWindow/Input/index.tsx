...
export const AiAssistantChatWindowInput = ({
  ...
  return (
    <div
      className={clsx(
        "px-docs_1 py-docs_0.75 border-t border-acmekit-border-base"
      )}
    >
      <form
      ...
      >
        <textarea
          className={clsx(
            "appearance-none text-base md:text-small placeholder:text-acmekit-fg-muted",
            "text-acmekit-fg-base max-h-[210px] overflow-auto resize-none bg-transparent",
            "focus:outline-none focus:ring-0 disabled:cursor-not-allowed max-h-[210px]",
            "disabled:!bg-transparent disabled:text-acmekit-fg-disabled disabled:placeholder:text-acmekit-fg-disabled"
          )}
          value={question}
          ...
          placeholder="Ask me a question about AcmeKit..."
          disabled={loading}
        />
        <div className="flex items-center justify-end gap-docs_1">
          ...
          >
            <button
              ...
              className={clsx(
                ...
                !active &&
                  "bg-transparent hover:bg-acmekit-button-transparent-hover text-acmekit-fg-muted hover:text-acmekit-fg-subtle",
                active &&
                  "bg-acmekit-tag-orange-bg hover:bg-acmekit-tag-orange-bg-hover text-acmekit-tag-orange-text",
            ...
            >
              {!active && <LightBulb />}
              {active && (
                <LightBulbSolid className="text-acmekit-tag-orange-icon" />
              )}
              Deep Thinking
            </button>
          </Tooltip>
          <button
            className={clsx(
              "appearance-none p-0 text-acmekit-fg-base disabled:text-acmekit-fg-disabled",
              "transition-colors"
            )}
