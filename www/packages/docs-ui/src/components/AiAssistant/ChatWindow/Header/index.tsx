...
import { ShieldCheck, XMark } from "@acmekit/icons"
  ...
  return (
    <div
      className={clsx(
        ...
        "border-acmekit-border-base border-b"
      )}
    >
      <div className="flex gap-[6px] items-center">
        <span className="text-h3 text-acmekit-fg-base">Ask Anything</span>
        <Tooltip
          tooltipChildren={
            <>
        ...
        >
          <ShieldCheck className="text-acmekit-fg-muted" />
        </Tooltip>
      </div>
      <Button
      ...
      >
        <XMark className="text-acmekit-fg-muted" height={15} width={15} />
      </Button>
    </div>
  )
}
