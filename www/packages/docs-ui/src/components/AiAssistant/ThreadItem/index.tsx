...
export const AiAssistantThreadItem = ({ item }: AiAssistantThreadItemProps) => {
  ...
  return (
    ...
    >
      ...
      <div
        className={clsx(
          "txt-small text-acmekit-fg-base",
      ...
      >
        <div
          className={clsx(
            "flex flex-col gap-docs_0.75",
            item.type === "question" && [
              "rounded-docs_xl bg-acmekit-tag-neutral-bg",
                    ...
                    <CodeMdx
                      ...
                      codeBlockProps={{
                        ...
                        overrideColors: {
                          ...
                          innerBorder: "border-acmekit-contrast-border-bot",
                        },
                      }}
                    />
                  )
        ...
        {item.type === "error" && (
          <span className="text-acmekit-fg-error">{item.content}</span>
        )}
      </div>
    </div>
  )
