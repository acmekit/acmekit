...
export const AiAssistantThreadItemActions = ({
  ...
  return (
    ...
    >
      {item.type === "question" && (
        <div className="flex gap-docs_0.25 items-center text-acmekit-fg-muted">
          ...
          <div className="flex gap-docs_0.25 items-center text-acmekit-fg-muted">
            ...
            {(feedback === null || feedback === "upvote") && (
              <ActionButton
                ...
                className={clsx(
                  feedback === "upvote" && "!text-acmekit-fg-muted"
                )}
              >
                <ThumbUp />
              </ActionButton>
            ...
            {(feedback === null || feedback === "downvote") && (
              <ActionButton
                ...
                className={clsx(
                  feedback === "downvote" && "!text-acmekit-fg-muted"
                )}
              >
                <ThumbDown />
              </ActionButton>
...
const ActionButton = ({ children, className, ...props }: ButtonProps) => {
  return (
    <Button
      variant="transparent"
      className={clsx(
        "text-acmekit-fg-muted hover:text-acmekit-fg-muted",
        "hover:bg-acmekit-bg-subtle-hover",
