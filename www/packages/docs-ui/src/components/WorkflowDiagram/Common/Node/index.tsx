  ...
  return (
    ...
    >
      ...
      >
        <div
          className={clsx(
            "shadow-borders-base flex w-fit bg-acmekit-bg-base",
        ...
        >
          {step.type === "hook" && (
            <div className="flex size-[20px] items-center justify-center text-acmekit-tag-orange-icon">
              <Bolt />
            </div>
          )}
          {step.when && (
            <div className="flex size-[20px] items-center justify-center text-acmekit-tag-green-icon">
              <InformationCircle />
            </div>
          )}
          <Text
