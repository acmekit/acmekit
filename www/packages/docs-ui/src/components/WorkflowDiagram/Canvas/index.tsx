  ...
  return (
    <div className="h-[200px] w-full rounded-docs_DEFAULT">
      ...
      >
        <div className="relative size-full overflow-hidden object-contain rounded-docs_DEFAULT shadow-elevation-card-rest">
          <div>
            ...
            <motion.div
              ...
              className={clsx(
                "bg-acmekit-bg-subtle relative size-[500rem] origin-top-left items-start justify-start overflow-hidden",
        ...
        <div className="bg-acmekit-bg-base shadow-borders-base text-acmekit-fg-subtle absolute bottom-docs_1 left-docs_1.5 flex h-[28px] items-center overflow-hidden rounded-docs_sm">
          <div className="flex items-center">
            <button
              ...
              disabled={!canZoomIn}
              aria-label="Zoom in"
              className="disabled:text-acmekit-fg-disabled transition-fg hover:bg-acmekit-bg-base-hover active:bg-acmekit-bg-base-pressed focus-visible:bg-acmekit-bg-base-pressed border-r p-docs_0.25 outline-none"
            >
              <PlusMini />
            </button>
            <div>
              <DropdownMenu>
                <DropdownMenu.Trigger
                  className="disabled:text-acmekit-fg-disabled transition-fg hover:bg-acmekit-bg-base-hover active:bg-acmekit-bg-base-pressed focus-visible:bg-acmekit-bg-base-pressed flex w-[50px] items-center justify-center border-r p-docs_0.25 outline-none"
                ...
                <DropdownMenu.Content className="bg-acmekit-bg-base">
          ...
          <button
            ...
            className="disabled:text-acmekit-fg-disabled transition-fg hover:bg-acmekit-bg-base-hover active:bg-acmekit-bg-base-pressed focus-visible:bg-acmekit-bg-base-pressed p-docs_0.25 outline-none"
          >
            <ArrowPathMini />
          </button>
        </div>
