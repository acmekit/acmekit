...
import { CheckCircleSolid, CircleMiniSolid, ListBullet } from "@acmekit/icons"
      ...
      >
        <>
          {!collapsed && (
            <div
              className={clsx(
                "bg-acmekit-bg-base shadow-elevation-flyout dark:shadow-elevation-flyout-dark rounded",
          ...
          {collapsed && (
            <Button
              variant="secondary"
              className={clsx(
                "!p-[10px] !shadow-elevation-flyout dark:!shadow-elevation-flyout-dark !text-acmekit-fg-subtle w-fit h-fit",
