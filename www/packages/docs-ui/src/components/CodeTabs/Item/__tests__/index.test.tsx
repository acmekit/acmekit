...
describe("render", () => {
  test("default render (loud blockStyle, not selected, light color mode)", () => {
    ...
    expect(button).toHaveClass("text-acmekit-contrast-fg-secondary")
    expect(button).not.toHaveClass("text-acmekit-contrast-fg-primary")
    expect(button).not.toHaveClass("xs:border-acmekit-border-base")
    expect(button).not.toHaveClass("xs:border-acmekit-code-border")
    expect(button).not.toHaveClass("text-acmekit-contrast-fg-primary")
    expect(button).not.toHaveClass("xs:border-acmekit-border-base")
    expect(button).not.toHaveClass("xs:border-acmekit-code-border")
    expect(button).not.toHaveClass("text-acmekit-contrast-fg-primary")
  ...
  test("render with selected (loud blockStyle, light color mode)", () => {
    ...
    expect(button).toHaveAttribute("role", "tab")
    expect(button).toHaveClass("text-acmekit-contrast-fg-primary")
    expect(button).not.toHaveClass("text-acmekit-contrast-fg-secondary")
    expect(button).not.toHaveClass("xs:border-acmekit-border-base")
    expect(button).not.toHaveClass("xs:border-acmekit-code-border")
  })
  ...
  test("render with subtle blockStyle (not selected, light color mode)", () => {
    ...
    expect(button).toHaveAttribute("aria-selected", "false")
    expect(button).toHaveAttribute("role", "tab")
    expect(button).toHaveClass("text-acmekit-fg-subtle hover:bg-acmekit-bg-base")
    expect(button).not.toHaveClass("text-acmekit-contrast-fg-secondary")
    expect(button).not.toHaveClass("xs:border-acmekit-code-border")
    expect(button).not.toHaveClass("text-acmekit-contrast-fg-primary")
    expect(button).not.toHaveClass("hover:bg-acmekit-code-bg-base")
  })
