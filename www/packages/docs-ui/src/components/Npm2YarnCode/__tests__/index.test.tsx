...
describe("render", () => {
  test("renders npm2yarn code", () => {
    const { container } = render(
      <Npm2YarnCode npmCode="npm install @acmekit/acmekit" />
    )
    ...
    expect(yarnCodeBlock).toHaveTextContent("yarn add @acmekit/acmekit")
    ...
    expect(pnpmCodeBlock).toHaveTextContent("pnpm add @acmekit/acmekit")
    ...
    expect(npmCodeBlock).toHaveTextContent("npm install @acmekit/acmekit")
  })

  test("renders npm2yarn code with custom code options", () => {
    const { container } = render(
      <Npm2YarnCode
        npmCode="npm install @acmekit/acmekit"
        title="Custom Title"
      />
    )
    expect(container).toBeInTheDocument()
