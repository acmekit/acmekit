...
test("renders purple badge", () => {
  ...
  expect(badge).toHaveClass(
    "bg-acmekit-tag-purple-bg",
    "text-acmekit-tag-purple-text",
    "border-acmekit-tag-purple-border"
  )
})
...
test("renders orange badge", () => {
  ...
  expect(badge).toBeInTheDocument()
  expect(badge).toHaveClass(
    "bg-acmekit-tag-orange-bg",
    "text-acmekit-tag-orange-text",
    "border-acmekit-tag-orange-border"
  )
})
...
test("renders green badge", () => {
  ...
  expect(badge).toBeInTheDocument()
  expect(badge).toHaveClass(
    "bg-acmekit-tag-green-bg",
    "text-acmekit-tag-green-text",
    "border-acmekit-tag-green-border"
  )
})
...
test("renders blue badge", () => {
  ...
  expect(badge).toBeInTheDocument()
  expect(badge).toHaveClass(
    "bg-acmekit-tag-blue-bg",
    "text-acmekit-tag-blue-text",
    "border-acmekit-tag-blue-border"
  )
})
...
test("renders red badge", () => {
  ...
  expect(badge).toBeInTheDocument()
  expect(badge).toHaveClass(
    "bg-acmekit-tag-red-bg",
    "text-acmekit-tag-red-text",
    "border-acmekit-tag-red-border"
  )
})
...
test("renders code badge", () => {
  ...
  expect(badge).toBeInTheDocument()
  expect(badge).toHaveClass(
    "bg-acmekit-contrast-bg-subtle",
    "text-acmekit-contrast-fg-secondary",
    "border-acmekit-contrast-border-bot"
  )
})
