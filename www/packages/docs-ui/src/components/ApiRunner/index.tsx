...
import { ArrowDownRightMini } from "@acmekit/icons"
    ...
    return (
      <div className="mb-docs_1" ref={ref}>
        {manualTestTrigger && (
          <div
            className={clsx(
              "bg-acmekit-bg-component rounded-docs_DEFAULT",
          ...
          >
            ...
            >
              <ArrowDownRightMini className="text-acmekit-fg-muted" />
              ...
              <ArrowRightDownIcon className="text-acmekit-fg-muted" />
            </div>
            <div
              className={clsx(
                "border-t border-acmekit-border-base",
