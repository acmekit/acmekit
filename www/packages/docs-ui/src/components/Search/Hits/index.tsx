...
export const SearchHits = ({
  ...
  return (
    <div
      className={clsx(
        "overflow-auto",
        "[&_mark]:bg-acmekit-bg-highlight",
        "[&_mark]:text-acmekit-fg-interactive"
      )}
      data-group
    >
      {hits.map((item, index) => {
        ...
        return (
          <div
            ...
            className={clsx(
              ...
              "focus:bg-acmekit-bg-base-hover",
              "focus:outline-none",
          ...
          >
            ...
            >
              ...
              <span className="text-compact-small text-acmekit-fg-subtle text-ellipsis overflow-hidden">
                {item.type === "content" && (
                  <>
                    {/* @ts-expect-error React v19 doesn't see this type as a React element */}
              ...
              <span
                className={clsx(
                  ...
                  "text-acmekit-fg-muted items-center text-compact-x-small"
                )}
              >
                {hierarchies}
              </span>
            ...
            {!!item.integration_vendor &&
              item.integration_vendor !== "AcmeKit" && (
