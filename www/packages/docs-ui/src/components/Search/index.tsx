  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <InstantSearch
        ...
        insights={true}
      >
        <div className={clsx("bg-acmekit-bg-base flex z-[1]")}>
          {/* @ts-expect-error React v19 doesn't see this type as a React element */}
          <SearchBox
            classNames={{
              root: clsx(
              ...
              input: clsx(
                "w-[calc(100%-40px)] h-full px-docs_1 py-docs_0.75 text-acmekit-fg-base",
                "placeholder:text-acmekit-fg-muted bg-acmekit-bg-base",
            ...
            submitIconComponent={() => <></>}
            resetIconComponent={() => (
              <span className="text-acmekit-fg-muted text-compact-small-plus hover:text-acmekit-fg-subtle">
                Clear
              </span>
            )}
