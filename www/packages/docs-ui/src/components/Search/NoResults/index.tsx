...
export const SearchNoResult = () => {
  return (
    ...
    >
      <MagnifierAlert className="text-acmekit-fg-base" />
      <div
        className={clsx(
      ...
      >
        <span className="text-compact-small-plus text-acmekit-fg-subtle">
          No results found.
        </span>
        <span className="text-acmekit-fg-muted txt-small text-center">
