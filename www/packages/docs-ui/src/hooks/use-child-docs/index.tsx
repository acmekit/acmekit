      ...
      <>
        ...
        {!searchResult.length && (
          <div className="flex flex-col justify-center items-center gap-docs_0.75">
            <ExclamationCircle className="text-acmekit-fg-subtle" />
            <span className="text-compact-small-plus text-acmekit-fg-base text-center">
              No results found matching your query.
            </span>
            <span className="text-compact-small text-acmekit-fg-subtle text-center">
