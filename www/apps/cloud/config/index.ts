...
export const config: DocsConfig = {
  ...globalConfig,
  titleSuffix: "AcmeKit Cloud Documentation",
  description:
    "Learn about Cloud, AcmeKit's PaaS offering for scalable deployments. Learn how to sign up, deploy, and manage your AcmeKit Cloud projects.",
  baseUrl,
