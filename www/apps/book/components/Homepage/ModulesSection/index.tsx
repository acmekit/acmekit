...
const HomepageModulesSection = () => {
  ...
  return (
    <div className="py-4 w-full border-y border-acmekit-border-base">
      <div
        className={clsx(
          "flex flex-col",
          "gap-[40px] xs:gap-4",
      ...
      >
        <div className="flex flex-col gap-0.5 lg:max-w-[560px]">
          ...
          />
          <h2 className="text-acmekit-fg-base text-h1">
            All commerce features are provided as extendable modules in AcmeKit.
          </h2>
...
const Section = ({ title, text, modules }: SectionProps) => {
  return (
    ...
    >
      <div className="flex flex-col gap-0.5 text-acmekit-fg-base w-full lg:w-1/3">
