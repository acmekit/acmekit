...
import { Book } from "@acmekit/icons"
...
const HomepageTopSection = () => {
  return (
    <div className="w-full relative">
      ...
      <div
        className={clsx(
          "absolute h-full lg:h-[calc(50%-32px)] border-b border-acmekit-border-base",
      ...
      >
        <div className="flex flex-col gap-1.5 pt-1 xs:pt-4 lg:py-4">
          <div className="flex flex-col gap-[10px]">
            ...
            <h2 className="text-acmekit-fg-base text-h1 text-pretty w-full md:w-2/3 lg:w-full">
        ...
        <div className="pt-4 hidden lg:flex flex-col gap-0.5">
          ...
          />
          <h2 className="text-acmekit-fg-base text-h1 text-pretty">
            A digital commerce platform with a built-in framework for
            customizations.
          </h2>
          <span className="text-small-plus text-acmekit-fg-subtle">
