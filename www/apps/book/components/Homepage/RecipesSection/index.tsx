  ...
  const cards: CardProps[] = [
    {
      ...
      href: "https://docs.acmekit.com/resources/recipes/marketplace/examples/vendors",
      icon: ShopIcon,
    },
    {
      type: "large",
      ...
      href: "https://docs.acmekit.com/resources/recipes/erp",
      icon: ErpIcon,
    },
    {
      type: "large",
      ...
      href: "https://docs.acmekit.com/resources/recipes/bundled-products/examples/standard",
    ...
    },
    {
      ...
      href: "https://docs.acmekit.com/resources/recipes/subscriptions/examples/standard",
    ...
    },
    {
      ...
      href: "https://docs.acmekit.com/resources/recipes/marketplace/examples/restaurant-delivery",
      icon: ChefHatIcon,
    },
    {
      type: "large",
      ...
      href: "https://docs.acmekit.com/resources/recipes/digital-products/examples/standard",
      ...
      >
        <div className="flex flex-col gap-1 w-full lg:w-1/3 xl:max-w-[336px]">
          <div className="flex flex-col gap-0.5">
            ...
            <h2 className="text-h1 text-acmekit-fg-base">
              AcmeKit’s framework supports any business use case.
            </h2>
            <span className="text-acmekit-fg-subtle text-small-plus">
          ...
          <Link
            href={"https://docs.acmekit.com/resources/recipes"}
