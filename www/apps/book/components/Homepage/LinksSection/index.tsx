...
const HomepageLinksSection = () => {
  const sections: SectionProps[] = [
    {
      title: "Customize AcmeKit Application",
      links: [
        {
        ...
        {
          href: "https://docs.acmekit.com/cloud/sign-up",
          text: "Deploy to AcmeKit Cloud",
        },
        {
          href: "https://docs.acmekit.com/resources/integrations",
    ...
    },
    {
      ...
      links: [
        ...
        {
          href: "https://docs.acmekit.com/ui",
    ...
    },
    {
      ...
      links: [
        {
          href: "https://docs.acmekit.com/resources/nextjs-starter",
          text: "Explore our storefront starter",
        },
        {
          href: "https://docs.acmekit.com/resources/storefront-development",
  ...
  return (
    <div
      className={clsx(
        ...
        "border-y border-acmekit-border-base xl:mx-auto"
      )}
    >
...
const Section = ({ title, links }: SectionProps) => {
  return (
    <div className="flex flex-col gap-0.5 flex-1">
      <h3 className="text-h3 text-acmekit-fg-base">{title}</h3>
