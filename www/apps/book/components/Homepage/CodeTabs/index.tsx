...
.cascades({
  delete: ["medias"]
    ...
    },
    {
      ...
      code: {
        lang: "ts",
        source: `class DigitalProductModuleService extends AcmeKitService({
  DigitalProduct,
}) {
...
export const config = defineWidgetConfig({
  ...
  () => {
    ...
    const created = createBrandsInAcmeKitStep({ 
      brands: toCreate
    })
    ...
    return new WorkflowResponse({
      created,
        ...
        highlights: [
          ...
          ["6", "createBrandsInAcmeKitStep", "Sync data to AcmeKit."],
        ],
      },
    },
  ]
  ...
  return (
    <div className="row-span-2 pt-[56px] hidden lg:flex flex-col gap-1">
      ...
      <div className="flex gap-[6px] items-center mx-0.5">
        ...
        <span className="text-acmekit-fg-subtle text-small">&#183;</span>
        <Link
