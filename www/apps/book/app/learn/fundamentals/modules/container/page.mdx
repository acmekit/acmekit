...
Instead, if your main service extends the `AcmeKitService` [service factory](../service-factory/page.mdx), you can resolve the internal services generated for each data model passed to the `AcmeKitService` function.
