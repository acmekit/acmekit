...
export const config: DocsConfig = {
  ...globalConfig,
  titleSuffix: "AcmeKit Admin User Guide",
  description:
    "Explore and learn how to use the AcmeKit Admin. Learn how to manage products, orders, customers, and more within the AcmeKit Admin dashboard.",
  baseUrl,
