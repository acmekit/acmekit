import { AcademicCapSolid, BookOpen } from "@acmekit/icons"
...
const NotFoundPage = () => {
  return (
    ...
    >
      ...
      <P>
        If you&apos;re looking for AcmeKit v1 documentation, it&apos;s been moved
        to <A href="https://docs.acmekit.com/v1">docs.acmekit.com/v1</A>.
      </P>
      <P>
        If you think this is a mistake, please{" "}
        <A href="https://github.com/acmekit/acmekit/issues/new?assignees=&labels=type%3A+docs&template=docs.yml">
