          ...
          <DividedLayout
            mainContent={
              <div>
                ...
                <Note>
                  This object&apos;s schema is as returned by AcmeKit&apos;s{" "}
                  {displayedArea} API routes. However, the related model in the
                  AcmeKit application may support more fields and relations. To
                  view the models in the AcmeKit application and their relations,
                  visit the{" "}
                  <Link
                    href="https://docs.acmekit.com/resources/commerce-modules"
                    variant="content"
                  >
                    Commerce Modules Documentation
                  </Link>
                </Note>
                <h4 className="border-acmekit-border-base border-b py-1.5 mt-2">
                  Fields
                </h4>
