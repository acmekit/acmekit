...
This documentation provides a reference to the `createRefundReasonStep`. It belongs to the `/medusa/core-flows` package.

This step creates one or more refund reasons.

```ts title="src/workflows/my-workflow.ts"
import { createWorkflow } from "/framework/workflows-sdk"
import { createRefundReasonStep } from "/medusa/core-flows"
