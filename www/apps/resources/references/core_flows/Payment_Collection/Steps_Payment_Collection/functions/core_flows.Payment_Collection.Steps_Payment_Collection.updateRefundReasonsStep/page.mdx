...
This documentation provides a reference to the `updateRefundReasonsStep`. It belongs to the `/medusa/core-flows` package.

This step updates one or more refund reasons.

```ts title="src/workflows/my-workflow.ts"
import { createWorkflow } from "/framework/workflows-sdk"
import { updateRefundReasonsStep } from "/medusa/core-flows"
