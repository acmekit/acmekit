...
This documentation provides a reference to the `deleteFilesWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { deleteFilesWorkflow } from "/medusa/core-flows"
