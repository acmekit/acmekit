...
This documentation provides a reference to the `createCustomerGroupsWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { createCustomerGroupsWorkflow } from "/medusa/core-flows"
