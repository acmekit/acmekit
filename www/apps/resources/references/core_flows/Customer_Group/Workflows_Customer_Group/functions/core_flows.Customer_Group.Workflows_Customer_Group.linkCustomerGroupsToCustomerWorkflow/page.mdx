...
This documentation provides a reference to the `linkCustomerGroupsToCustomerWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { linkCustomerGroupsToCustomerWorkflow } from "/medusa/core-flows"
