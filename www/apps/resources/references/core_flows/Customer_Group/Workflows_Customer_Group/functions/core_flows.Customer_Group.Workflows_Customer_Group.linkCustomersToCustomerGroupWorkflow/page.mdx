...
This documentation provides a reference to the `linkCustomersToCustomerGroupWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { linkCustomersToCustomerGroupWorkflow } from "/medusa/core-flows"
