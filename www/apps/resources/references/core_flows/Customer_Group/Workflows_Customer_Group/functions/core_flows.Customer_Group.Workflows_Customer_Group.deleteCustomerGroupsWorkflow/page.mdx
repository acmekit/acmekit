...
This documentation provides a reference to the `deleteCustomerGroupsWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { deleteCustomerGroupsWorkflow } from "/medusa/core-flows"
