...
This documentation provides a reference to the `removeShippingMethodAdjustmentsStep`. It belongs to the `/medusa/core-flows` package.

This step removes shipping method adjustments from a cart.

```ts title="src/workflows/my-workflow.ts"
import { createWorkflow } from "/framework/workflows-sdk"
import { removeShippingMethodAdjustmentsStep } from "/medusa/core-flows"
