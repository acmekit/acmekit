...
This documentation provides a reference to the `updateLineItemInCartWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { updateLineItemInCartWorkflow } from "/medusa/core-flows"
