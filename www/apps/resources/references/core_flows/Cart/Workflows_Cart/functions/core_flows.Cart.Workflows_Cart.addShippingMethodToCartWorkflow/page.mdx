...
This documentation provides a reference to the `addShippingMethodToCartWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { addShippingMethodToCartWorkflow } from "/medusa/core-flows"
