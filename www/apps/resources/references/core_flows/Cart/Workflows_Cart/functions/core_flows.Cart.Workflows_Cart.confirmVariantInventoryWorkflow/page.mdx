...
This documentation provides a reference to the `confirmVariantInventoryWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { confirmVariantInventoryWorkflow } from "/medusa/core-flows"
