...
This documentation provides a reference to the `setAuthAppMetadataWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { setAuthAppMetadataWorkflow } from "/medusa/core-flows"
