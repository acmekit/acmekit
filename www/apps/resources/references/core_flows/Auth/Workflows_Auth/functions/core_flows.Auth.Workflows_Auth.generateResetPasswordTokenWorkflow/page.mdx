...
This documentation provides a reference to the `generateResetPasswordTokenWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { generateResetPasswordTokenWorkflow } from "/medusa/core-flows"
