...
This documentation provides a reference to the `createShippingOptionTypesWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { createShippingOptionTypesWorkflow } from "/medusa/core-flows"
