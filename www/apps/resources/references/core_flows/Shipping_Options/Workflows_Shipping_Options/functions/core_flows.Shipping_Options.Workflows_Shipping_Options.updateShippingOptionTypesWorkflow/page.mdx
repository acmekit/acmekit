...
This documentation provides a reference to the `updateShippingOptionTypesWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { updateShippingOptionTypesWorkflow } from "/medusa/core-flows"
