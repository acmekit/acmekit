...
This documentation provides a reference to the `batchLinksWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { batchLinksWorkflow } from "/medusa/core-flows"
