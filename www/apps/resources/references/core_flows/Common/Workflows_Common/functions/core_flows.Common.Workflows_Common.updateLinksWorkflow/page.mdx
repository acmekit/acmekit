...
This documentation provides a reference to the `updateLinksWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { updateLinksWorkflow } from "/medusa/core-flows"
