...
This documentation provides a reference to the `createCustomerAddressesWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { createCustomerAddressesWorkflow } from "/medusa/core-flows"
