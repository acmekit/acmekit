...
This documentation provides a reference to the `removeCustomerAccountWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { removeCustomerAccountWorkflow } from "/medusa/core-flows"
