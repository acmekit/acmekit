...
This documentation provides a reference to the `deleteCustomerAddressesWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { deleteCustomerAddressesWorkflow } from "/medusa/core-flows"
