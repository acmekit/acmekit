...
This documentation provides a reference to the `createCustomerAccountWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { createCustomerAccountWorkflow } from "/medusa/core-flows"
