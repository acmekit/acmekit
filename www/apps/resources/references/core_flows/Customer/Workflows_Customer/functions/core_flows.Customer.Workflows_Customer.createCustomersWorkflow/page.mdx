...
This documentation provides a reference to the `createCustomersWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { createCustomersWorkflow } from "/medusa/core-flows"
