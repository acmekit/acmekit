...
This documentation provides a reference to the `deleteCustomersWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { deleteCustomersWorkflow } from "/medusa/core-flows"
