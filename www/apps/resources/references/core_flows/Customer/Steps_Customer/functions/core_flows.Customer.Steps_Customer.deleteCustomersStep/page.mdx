...
This documentation provides a reference to the `deleteCustomersStep`. It belongs to the `/medusa/core-flows` package.

This step deletes one or more customers.

```ts title="src/workflows/my-workflow.ts"
import { createWorkflow } from "/framework/workflows-sdk"
import { deleteCustomersStep } from "/medusa/core-flows"
