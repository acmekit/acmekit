...
This documentation provides a reference to the `createInventoryLevelsStep`. It belongs to the `/medusa/core-flows` package.

This step creates one or more inventory levels.

```ts title="src/workflows/my-workflow.ts"
import { createWorkflow } from "/framework/workflows-sdk"
import { createInventoryLevelsStep } from "/medusa/core-flows"
