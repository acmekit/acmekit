...
This documentation provides a reference to the `createInventoryItemsStep`. It belongs to the `/medusa/core-flows` package.

This step creates one or more inventory items.

```ts title="src/workflows/my-workflow.ts"
import { createWorkflow } from "/framework/workflows-sdk"
import { createInventoryItemsStep } from "/medusa/core-flows"
