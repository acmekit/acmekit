...
This documentation provides a reference to the `updateInventoryItemsWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { updateInventoryItemsWorkflow } from "/medusa/core-flows"
