...
This documentation provides a reference to the `createInventoryItemsWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { createInventoryItemsWorkflow } from "/medusa/core-flows"
