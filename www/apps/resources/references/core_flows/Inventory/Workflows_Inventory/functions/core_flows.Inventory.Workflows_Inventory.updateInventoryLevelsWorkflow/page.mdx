...
This documentation provides a reference to the `updateInventoryLevelsWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { updateInventoryLevelsWorkflow } from "/medusa/core-flows"
