...
This documentation provides a reference to the `deleteInventoryItemWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { deleteInventoryItemWorkflow } from "/medusa/core-flows"
