...
This documentation provides a reference to the `updateRegionsWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { updateRegionsWorkflow } from "/medusa/core-flows"
