...
This documentation provides a reference to the `deleteRegionsWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { deleteRegionsWorkflow } from "/medusa/core-flows"
