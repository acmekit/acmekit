...
This documentation provides a reference to the `createRegionsWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { createRegionsWorkflow } from "/medusa/core-flows"
