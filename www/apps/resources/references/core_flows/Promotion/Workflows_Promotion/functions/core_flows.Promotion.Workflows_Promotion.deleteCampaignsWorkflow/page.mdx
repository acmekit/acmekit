...
This documentation provides a reference to the `deleteCampaignsWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { deleteCampaignsWorkflow } from "/medusa/core-flows"
