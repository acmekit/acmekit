...
This documentation provides a reference to the `updatePromotionsStatusWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { updatePromotionsStatusWorkflow } from "/medusa/core-flows"
