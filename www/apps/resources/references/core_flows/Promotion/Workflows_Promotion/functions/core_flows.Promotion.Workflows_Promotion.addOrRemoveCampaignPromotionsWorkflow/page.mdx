...
This documentation provides a reference to the `addOrRemoveCampaignPromotionsWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { addOrRemoveCampaignPromotionsWorkflow } from "/medusa/core-flows"
