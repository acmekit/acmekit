...
This documentation provides a reference to the `batchPromotionRulesWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { batchPromotionRulesWorkflow } from "/medusa/core-flows"
