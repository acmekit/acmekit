...
This documentation provides a reference to the `updateCampaignsWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { updateCampaignsWorkflow } from "/medusa/core-flows"
