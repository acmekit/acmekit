...
This documentation provides a reference to the `createCampaignsWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { createCampaignsWorkflow } from "/medusa/core-flows"
