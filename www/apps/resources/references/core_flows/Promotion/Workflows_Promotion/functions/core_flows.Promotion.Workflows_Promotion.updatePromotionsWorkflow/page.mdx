...
This documentation provides a reference to the `updatePromotionsWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { updatePromotionsWorkflow } from "/medusa/core-flows"
