...
This documentation provides a reference to the `updatePromotionRulesWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { updatePromotionRulesWorkflow } from "/medusa/core-flows"
