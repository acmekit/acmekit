...
This documentation provides a reference to the `deletePromotionRulesWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { deletePromotionRulesWorkflow } from "/medusa/core-flows"
