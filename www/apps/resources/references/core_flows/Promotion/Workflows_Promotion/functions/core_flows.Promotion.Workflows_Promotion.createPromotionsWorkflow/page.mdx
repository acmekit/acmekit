...
This documentation provides a reference to the `createPromotionsWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { createPromotionsWorkflow } from "/medusa/core-flows"
