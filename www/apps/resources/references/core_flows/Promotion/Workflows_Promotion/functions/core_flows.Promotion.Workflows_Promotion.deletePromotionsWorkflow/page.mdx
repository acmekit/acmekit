...
This documentation provides a reference to the `deletePromotionsWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { deletePromotionsWorkflow } from "/medusa/core-flows"
