...
This documentation provides a reference to the `deleteUsersWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { deleteUsersWorkflow } from "/medusa/core-flows"
