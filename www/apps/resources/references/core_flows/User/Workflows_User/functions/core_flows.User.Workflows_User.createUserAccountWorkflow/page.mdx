...
This documentation provides a reference to the `createUserAccountWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { createUserAccountWorkflow } from "/medusa/core-flows"
