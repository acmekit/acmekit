...
This documentation provides a reference to the `removeUserAccountWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { removeUserAccountWorkflow } from "/medusa/core-flows"
