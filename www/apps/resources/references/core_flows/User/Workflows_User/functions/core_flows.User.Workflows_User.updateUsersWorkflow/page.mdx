...
This documentation provides a reference to the `updateUsersWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { updateUsersWorkflow } from "/medusa/core-flows"
