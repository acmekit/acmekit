...
This documentation provides a reference to the `linkSalesChannelsToStockLocationWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { linkSalesChannelsToStockLocationWorkflow } from "/medusa/core-flows"
