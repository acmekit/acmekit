...
This documentation provides a reference to the `updateStockLocationsWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { updateStockLocationsWorkflow } from "/medusa/core-flows"
