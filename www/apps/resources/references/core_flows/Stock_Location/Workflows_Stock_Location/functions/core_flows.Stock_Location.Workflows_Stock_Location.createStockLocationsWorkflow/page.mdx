...
This documentation provides a reference to the `createStockLocationsWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { createStockLocationsWorkflow } from "/medusa/core-flows"
