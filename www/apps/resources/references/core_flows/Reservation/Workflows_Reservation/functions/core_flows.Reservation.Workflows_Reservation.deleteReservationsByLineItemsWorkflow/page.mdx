...
This documentation provides a reference to the `deleteReservationsByLineItemsWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { deleteReservationsByLineItemsWorkflow } from "/medusa/core-flows"
