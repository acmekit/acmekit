...
This documentation provides a reference to the `updateReservationsWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { updateReservationsWorkflow } from "/medusa/core-flows"
