...
This documentation provides a reference to the `deleteReservationsWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { deleteReservationsWorkflow } from "/medusa/core-flows"
