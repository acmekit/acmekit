...
This documentation provides a reference to the `deleteShippingProfileWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { deleteShippingProfileWorkflow } from "/medusa/core-flows"
