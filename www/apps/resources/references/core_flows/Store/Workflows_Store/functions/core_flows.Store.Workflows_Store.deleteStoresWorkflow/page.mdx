...
This documentation provides a reference to the `deleteStoresWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { deleteStoresWorkflow } from "/medusa/core-flows"
