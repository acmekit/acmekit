...
This documentation provides a reference to the `updateStoresWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { updateStoresWorkflow } from "/medusa/core-flows"
