...
This documentation provides a reference to the `createStoresWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { createStoresWorkflow } from "/medusa/core-flows"
