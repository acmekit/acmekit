...
This documentation provides a reference to the `processPaymentWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { processPaymentWorkflow } from "/medusa/core-flows"
