...
This documentation provides a reference to the `updateSalesChannelsWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { updateSalesChannelsWorkflow } from "/medusa/core-flows"
