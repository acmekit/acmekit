...
This documentation provides a reference to the `createSalesChannelsWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { createSalesChannelsWorkflow } from "/medusa/core-flows"
