...
This documentation provides a reference to the `deleteSalesChannelsWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { deleteSalesChannelsWorkflow } from "/medusa/core-flows"
