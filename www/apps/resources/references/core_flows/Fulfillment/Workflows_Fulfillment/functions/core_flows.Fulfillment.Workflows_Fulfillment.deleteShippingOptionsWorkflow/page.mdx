...
This documentation provides a reference to the `deleteShippingOptionsWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { deleteShippingOptionsWorkflow } from "/medusa/core-flows"
