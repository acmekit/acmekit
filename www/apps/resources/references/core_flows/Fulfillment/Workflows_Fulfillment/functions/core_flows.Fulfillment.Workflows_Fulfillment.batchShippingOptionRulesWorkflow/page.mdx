...
This documentation provides a reference to the `batchShippingOptionRulesWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { batchShippingOptionRulesWorkflow } from "/medusa/core-flows"
