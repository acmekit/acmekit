...
This documentation provides a reference to the `deleteServiceZonesWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { deleteServiceZonesWorkflow } from "/medusa/core-flows"
