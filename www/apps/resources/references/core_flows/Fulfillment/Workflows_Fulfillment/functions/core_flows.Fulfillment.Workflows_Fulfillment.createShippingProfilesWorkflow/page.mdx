...
This documentation provides a reference to the `createShippingProfilesWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { createShippingProfilesWorkflow } from "/medusa/core-flows"
