...
This documentation provides a reference to the `deleteShippingOptionRulesStep`. It belongs to the `/medusa/core-flows` package.

This step deletes one or more shipping option rules.

```ts title="src/workflows/my-workflow.ts"
import { createWorkflow } from "/framework/workflows-sdk"
import { deleteShippingOptionRulesStep } from "/medusa/core-flows"
