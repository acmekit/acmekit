...
This documentation provides a reference to the `deleteCollectionsWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { deleteCollectionsWorkflow } from "/medusa/core-flows"
