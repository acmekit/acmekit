...
This documentation provides a reference to the `deleteProductTagsWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { deleteProductTagsWorkflow } from "/medusa/core-flows"
