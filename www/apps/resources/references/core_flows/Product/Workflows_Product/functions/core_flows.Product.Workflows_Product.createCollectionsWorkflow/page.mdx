...
This documentation provides a reference to the `createCollectionsWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { createCollectionsWorkflow } from "/medusa/core-flows"
