...
This documentation provides a reference to the `updateCollectionsWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { updateCollectionsWorkflow } from "/medusa/core-flows"
