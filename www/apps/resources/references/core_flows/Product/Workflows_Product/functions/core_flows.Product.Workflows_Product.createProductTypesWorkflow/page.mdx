...
This documentation provides a reference to the `createProductTypesWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { createProductTypesWorkflow } from "/medusa/core-flows"
