...
This documentation provides a reference to the `createProductVariantsWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { createProductVariantsWorkflow } from "/medusa/core-flows"
