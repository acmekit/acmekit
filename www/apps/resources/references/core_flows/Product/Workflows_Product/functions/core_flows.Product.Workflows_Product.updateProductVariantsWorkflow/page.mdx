...
This documentation provides a reference to the `updateProductVariantsWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { updateProductVariantsWorkflow } from "/medusa/core-flows"
