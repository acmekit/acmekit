...
This documentation provides a reference to the `batchLinkProductsToCollectionWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { batchLinkProductsToCollectionWorkflow } from "/medusa/core-flows"
