...
This documentation provides a reference to the `deleteProductTypesWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { deleteProductTypesWorkflow } from "/medusa/core-flows"
