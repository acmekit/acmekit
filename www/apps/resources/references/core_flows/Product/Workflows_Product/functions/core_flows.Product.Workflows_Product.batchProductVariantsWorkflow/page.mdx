...
This documentation provides a reference to the `batchProductVariantsWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { batchProductVariantsWorkflow } from "/medusa/core-flows"
