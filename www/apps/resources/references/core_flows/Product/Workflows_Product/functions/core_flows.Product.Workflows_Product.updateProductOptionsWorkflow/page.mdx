...
This documentation provides a reference to the `updateProductOptionsWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { updateProductOptionsWorkflow } from "/medusa/core-flows"
