...
This documentation provides a reference to the `createProductOptionsWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { createProductOptionsWorkflow } from "/medusa/core-flows"
