...
This documentation provides a reference to the `updateProductTagsWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { updateProductTagsWorkflow } from "/medusa/core-flows"
