...
This documentation provides a reference to the `deleteProductVariantsWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { deleteProductVariantsWorkflow } from "/medusa/core-flows"
