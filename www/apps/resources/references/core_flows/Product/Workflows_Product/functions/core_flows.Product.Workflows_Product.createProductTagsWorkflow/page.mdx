...
This documentation provides a reference to the `createProductTagsWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { createProductTagsWorkflow } from "/medusa/core-flows"
