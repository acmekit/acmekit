...
This documentation provides a reference to the `updateProductTypesWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { updateProductTypesWorkflow } from "/medusa/core-flows"
