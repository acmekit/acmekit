...
This documentation provides a reference to the `deleteProductsWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { deleteProductsWorkflow } from "/medusa/core-flows"
