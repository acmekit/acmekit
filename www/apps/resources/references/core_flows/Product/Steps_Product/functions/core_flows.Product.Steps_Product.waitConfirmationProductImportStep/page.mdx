...
This documentation provides a reference to the `waitConfirmationProductImportStep`. It belongs to the `/medusa/core-flows` package.
...
import { waitConfirmationProductImportStep } from "/medusa/core-flows"
