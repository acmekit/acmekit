...
This documentation provides a reference to the `updatePricePreferencesWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { updatePricePreferencesWorkflow } from "/medusa/core-flows"
