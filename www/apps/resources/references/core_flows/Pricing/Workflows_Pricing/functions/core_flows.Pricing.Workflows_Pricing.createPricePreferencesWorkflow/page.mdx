...
This documentation provides a reference to the `createPricePreferencesWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { createPricePreferencesWorkflow } from "/medusa/core-flows"
