...
This documentation provides a reference to the `createPriceListsWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { createPriceListsWorkflow } from "/medusa/core-flows"
