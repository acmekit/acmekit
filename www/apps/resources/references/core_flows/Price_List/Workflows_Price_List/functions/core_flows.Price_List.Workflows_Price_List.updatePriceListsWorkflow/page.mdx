...
This documentation provides a reference to the `updatePriceListsWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { updatePriceListsWorkflow } from "/medusa/core-flows"
