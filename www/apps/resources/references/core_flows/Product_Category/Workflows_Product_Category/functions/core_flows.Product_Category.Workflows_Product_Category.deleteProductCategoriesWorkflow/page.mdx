...
This documentation provides a reference to the `deleteProductCategoriesWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { deleteProductCategoriesWorkflow } from "/medusa/core-flows"
