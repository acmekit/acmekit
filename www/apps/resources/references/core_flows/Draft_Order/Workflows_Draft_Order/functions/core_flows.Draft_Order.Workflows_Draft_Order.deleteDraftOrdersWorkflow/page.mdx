...
This documentation provides a reference to the `deleteDraftOrdersWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { deleteDraftOrdersWorkflow } from "/medusa/core-flows"
