...
This documentation provides a reference to the `cancelOrderClaimStep`. It belongs to the `/medusa/core-flows` package.

This step cancels a claim.

```ts title="src/workflows/my-workflow.ts"
import { createWorkflow } from "/framework/workflows-sdk"
import { cancelOrderClaimStep } from "/medusa/core-flows"
