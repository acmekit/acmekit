...
This documentation provides a reference to the `registerOrderDeliveryStep`. It belongs to the `/medusa/core-flows` package.

This step registers a delivery for an order fulfillment.

```ts title="src/workflows/my-workflow.ts"
import { createWorkflow } from "/framework/workflows-sdk"
import { registerOrderDeliveryStep } from "/medusa/core-flows"
