...
This documentation provides a reference to the `declineOrderChangeStep`. It belongs to the `/medusa/core-flows` package.

This step declines an order change.

```ts title="src/workflows/my-workflow.ts"
import { createWorkflow } from "/framework/workflows-sdk"
import { declineOrderChangeStep } from "/medusa/core-flows"
