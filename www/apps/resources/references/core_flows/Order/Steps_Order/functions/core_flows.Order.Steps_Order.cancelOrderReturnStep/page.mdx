...
This documentation provides a reference to the `cancelOrderReturnStep`. It belongs to the `/medusa/core-flows` package.

This step cancels a return.

```ts title="src/workflows/my-workflow.ts"
import { createWorkflow } from "/framework/workflows-sdk"
import { cancelOrderReturnStep } from "/medusa/core-flows"
