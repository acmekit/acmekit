...
This documentation provides a reference to the `updateReturnsStep`. It belongs to the `/medusa/core-flows` package.

This step updates one or more returns.

```ts title="src/workflows/my-workflow.ts"
import { createWorkflow } from "/framework/workflows-sdk"
import { updateReturnsStep } from "/medusa/core-flows"
