...
This documentation provides a reference to the `addOrderTransactionStep`. It belongs to the `/medusa/core-flows` package.

This step creates order transactions.

```ts title="src/workflows/my-workflow.ts"
import { createWorkflow } from "/framework/workflows-sdk"
import { addOrderTransactionStep } from "/medusa/core-flows"
