...
This documentation provides a reference to the `markPaymentCollectionAsPaid`. It belongs to the `/medusa/core-flows` package.
...
import { markPaymentCollectionAsPaid } from "/medusa/core-flows"
