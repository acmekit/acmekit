...
This documentation provides a reference to the `createOrderPaymentCollectionWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { createOrderPaymentCollectionWorkflow } from "/medusa/core-flows"
