...
This documentation provides a reference to the `fetchShippingOptionForOrderWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { fetchShippingOptionForOrderWorkflow } from "/medusa/core-flows"
