...
This documentation provides a reference to the `updateOrderTaxLinesWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { updateOrderTaxLinesWorkflow } from "/medusa/core-flows"
