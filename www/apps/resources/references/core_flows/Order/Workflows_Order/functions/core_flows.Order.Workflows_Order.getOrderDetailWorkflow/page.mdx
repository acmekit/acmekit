...
This documentation provides a reference to the `getOrderDetailWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { getOrderDetailWorkflow } from "/medusa/core-flows"
