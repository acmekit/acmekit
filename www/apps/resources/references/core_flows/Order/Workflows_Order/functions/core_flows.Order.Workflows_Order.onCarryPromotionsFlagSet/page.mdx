...
This documentation provides a reference to the `onCarryPromotionsFlagSet`. It belongs to the `/medusa/core-flows` package.
...
import { onCarryPromotionsFlagSet } from "/medusa/core-flows"
