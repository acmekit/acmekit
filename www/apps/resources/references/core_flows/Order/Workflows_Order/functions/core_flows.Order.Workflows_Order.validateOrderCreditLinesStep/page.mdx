...
This documentation provides a reference to the `validateOrderCreditLinesStep`. It belongs to the `/medusa/core-flows` package.

```ts title="src/workflows/my-workflow.ts"
import { createWorkflow } from "/framework/workflows-sdk"
import { validateOrderCreditLinesStep } from "/medusa/core-flows"
