...
This documentation provides a reference to the `deleteInvitesWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { deleteInvitesWorkflow } from "/medusa/core-flows"
