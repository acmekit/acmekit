...
This documentation provides a reference to the `acceptInviteWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { acceptInviteWorkflow } from "/medusa/core-flows"
