...
This documentation provides a reference to the `createInvitesWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { createInvitesWorkflow } from "/medusa/core-flows"
