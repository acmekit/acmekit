...
This documentation provides a reference to the `refreshInviteTokensStep`. It belongs to the `/medusa/core-flows` package.

This step refreshes the tokens of one or more invites.

```ts title="src/workflows/my-workflow.ts"
import { createWorkflow } from "/framework/workflows-sdk"
import { refreshInviteTokensStep } from "/medusa/core-flows"
