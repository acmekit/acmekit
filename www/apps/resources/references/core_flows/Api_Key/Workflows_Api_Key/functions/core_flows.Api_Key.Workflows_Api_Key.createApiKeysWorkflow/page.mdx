...
This documentation provides a reference to the `createApiKeysWorkflow`. It belongs to the `/medusa/core-flows` package.
...
import { createApiKeysWorkflow } from "/medusa/core-flows"
