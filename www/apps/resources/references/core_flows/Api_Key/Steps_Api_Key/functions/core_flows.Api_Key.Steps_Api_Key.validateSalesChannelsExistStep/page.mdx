...
This documentation provides a reference to the `validateSalesChannelsExistStep`. It belongs to the `/medusa/core-flows` package.
...
import { validateSalesChannelsExistStep } from "/medusa/core-flows"
