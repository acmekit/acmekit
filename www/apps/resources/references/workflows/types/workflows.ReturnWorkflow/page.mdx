 ...
 **ReturnWorkflow**: `<TDataOverride, TResultOverride>`(`container?`: [AcmeKitContainer](../workflows.AcmeKitContainer/page.mdx) \| ``{ __joinerConfig: [ModuleJoinerConfig](../workflows.ModuleJoinerConfig/page.mdx) ; __definition: [ModuleDefinition](../workflows.ModuleDefinition/page.mdx)  }``[]) => Omit&#60;[LocalWorkflow](../../classes/workflows.LocalWorkflow/page.mdx), "run" \| "registerStepSuccess" \| "registerStepFailure" \| "cancel" \| "retryStep"&#62; & [ExportedWorkflow](../workflows.ExportedWorkflow/page.mdx)&#60;TData, TResult, TDataOverride, TResultOverride&#62; & `object`
