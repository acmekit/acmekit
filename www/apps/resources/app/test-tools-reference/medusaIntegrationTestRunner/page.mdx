...
This is a reference to the `medusaIntegrationTestRunner` function provided by the `/test-utils` package.
  ...
  types={[
    {
      ...
      children: [
        ...
        },
        {
          ...
          children: [
            {
              type: "`(container: AcmeKitContainer) => Promise<void>`",
