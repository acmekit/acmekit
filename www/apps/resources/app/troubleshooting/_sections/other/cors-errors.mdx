...
1. [http.appCors](!docs!/learn/configurations/medusa-config#httpappCors): Allowed origins for requests to routes starting with `/store`. By default, it's set to `http://localhost:8000` for local development.
