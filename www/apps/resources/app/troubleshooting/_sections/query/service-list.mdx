...
This method is generated for you if your service extends `AcmeKitService`:
...
In the above example, the `listPost` method is generated for you because the `BlogModuleService` extends `AcmeKitService`.
