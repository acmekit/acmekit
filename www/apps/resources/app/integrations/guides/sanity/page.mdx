...
export const POST = async (req: AcmeKitRequest, res: MedusaResponse) => {
...
import { AdminProduct, DetailWidgetProps } from "/types"
import { ArrowUpRightOnBox } from "/icons"
import { Button, CodeBlock, Container, StatusBadge, toast } from "/ui"
