...
```bash npm2yarn
npm install /js-sdk@latest /types@latest
```

You install two libraries:

- `/js-sdk`: the Medusa JS SDK.
- `/types`: Medusa's types library, which is useful if you're using TypeScript in your development.
...
import { Container, Heading, Button, Text } from "/ui"
