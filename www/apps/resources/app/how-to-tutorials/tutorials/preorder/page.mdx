...
import { Github, PlaySolid, EllipsisHorizontal } from "/icons"
...
import { AcmeKitService } from "/framework/utils"
import { PreorderVariant } from "./models/preorder-variant"
import { Preorder } from "./models/preorder"

export default class PreorderModuleService extends AcmeKitService({
  PreorderVariant,
  Preorder,
}) {}
```

The `PreorderModuleService` extends `AcmeKitService`, which generates a class with data-management methods for your module's data models. This saves you time on implementing Create, Read, Update, and Delete (CRUD) methods.

So, the `PreorderModuleService` class now has methods like `createPreorders` and `retrievePreorder`.

<Note>

Find all methods generated by the `AcmeKitService` in [the Service Factory reference](../../../service-factory-reference/page.mdx).
...
import { defineLink } from "/framework/utils"
import PreorderModule from "../modules/preorder"
import OrderModule from "/medusa/order"
...
The `useQueryGraphStep` and `createRemoteLinkStep` are available through Medusa's `/medusa/core-flows` package. You'll implement other steps in the workflow.
...
import { createWorkflow, transform, when, WorkflowResponse } from "/framework/workflows-sdk"
import { createRemoteLinkStep, useQueryGraphStep } from "/medusa/core-flows"
...
As of [Medusa v2.13.0](https://github.com/medusajs/medusa/releases/tag/v2.13.0), Zod should be imported from `/framework/zod`.
...
import { createWorkflow, WorkflowResponse } from "/framework/workflows-sdk"
import { useQueryGraphStep } from "/medusa/core-flows"
...
import { Calendar, EllipsisHorizontal, Pencil, Plus, XCircle } from "/icons"
...
import { CartLineItemDTO, ProductVariantDTO } from "/framework/types"
import { createStep, StepResponse } from "/framework/workflows-sdk"
...
import { AcmeKitRequest, MedusaResponse } from "/framework/http"
...
export const validateCartHookHighlights = [
  ...
  ["55", "AcmeKitError", "Throw an error if the cart has mixed pre-order and available items."],
]
...
import { addToCartWorkflow } from "/medusa/core-flows"
import { InferTypeOf } from "/framework/types"
...
import { AuthenticatedMedusaRequest, MedusaResponse } from "/framework/http"
...
import { defineWidgetConfig } from "/admin-sdk"
import { DetailWidgetProps, HttpTypes } from "/framework/types"
import { Container, Heading, StatusBadge, Text } from "/ui"
...
import { InferTypeOf, OrderLineItemDTO } from "/framework/types"
import { createStep, StepResponse } from "/framework/workflows-sdk"
import { PreorderVariant } from "../../modules/preorder/models/preorder-variant"
...
import { PreorderVariant } from "../modules/preorder/models/preorder-variant"
import { createWorkflow, WorkflowResponse } from "/framework/workflows-sdk"
import { createOrderFulfillmentWorkflow, emitEventStep, useQueryGraphStep } from "/medusa/core-flows"
...
import { PreorderVariant } from "../modules/preorder/models/preorder-variant"
import { createWorkflow, transform, when, WorkflowResponse } from "/framework/workflows-sdk"
import { capturePaymentWorkflow, createOrderFulfillmentWorkflow, emitEventStep, useQueryGraphStep } from "/medusa/core-flows"
import { retrieveItemsToFulfillStep, RetrieveItemsToFulfillStepInput } from "./steps/retrieve-items-to-fulfill"
import { updatePreordersStep } from "./steps/update-preorders"
import { PreorderStatus } from "../modules/preorder/models/preorder"
...
export default async function fulfillPreordersJob(container: AcmeKitContainer) {
  const query = container.resolve("query")
...
import { InferTypeOf } from "/framework/types"
import { createWorkflow, transform, WorkflowResponse } from "/framework/workflows-sdk"
import { emitEventStep } from "/medusa/core-flows"
import { updatePreordersStep } from "./steps/update-preorders"
...
import { SubscriberArgs, type SubscriberConfig } from "/framework"
import { InferTypeOf } from "/framework/types"
...
import { InferTypeOf, OrderDTO, OrderLineItemDTO, ProductVariantDTO } from "/framework/types"
import { PreorderVariant } from "../../modules/preorder/models/preorder-variant"
import { Preorder, PreorderStatus } from "../../modules/preorder/models/preorder"
import { createStep, StepResponse } from "/framework/workflows-sdk"
...
import { createWorkflow, transform, WorkflowResponse } from "/framework/workflows-sdk"
import { emitEventStep, useQueryGraphStep } from "/medusa/core-flows"
...
import { SubscriberArgs, type SubscriberConfig } from "/framework"
import { OrderChangeActionDTO } from "/framework/types"
