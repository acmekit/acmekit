...
class TierModuleService extends AcmeKitService({
  Tier,
  TierRule,
}) {
}
...
The `TierModuleService` extends `AcmeKitService` from the Modules SDK, which generates a class with data-management methods for your module's data models. This saves you time implementing Create, Read, Update, and Delete (CRUD) methods.
...
import { defineLink } from "/framework/utils"
import TierModule from "../modules/tier"
import PromotionModule from "/medusa/promotion"
...
export async function POST(
  req: AcmeKitRequest<CreateTierInput>,
  res: MedusaResponse
): Promise<void> {
...
import { FocusModal, Heading, Label, Input, Button, Select, IconButton, toast } from "/ui"
...
export async function POST(
  req: AcmeKitRequest<UpdateTierInput>,
  res: MedusaResponse
): Promise<void> {
  const { id } = req.params
  const { name, promo_id, tier_rules } = req.validatedBody
...
import { Drawer, Heading, Label, Input, Button, Select, IconButton, toast } from "/ui"
import { useForm, Controller, FormProvider } from "react-hook-form"
import { useQuery, useMutation, useQueryClient } from "@tanstack/react-query"
import { sdk } from "../lib/sdk"
...
import { Code, Container, Heading, Text } from "/ui"
...
import { Heading, DataTable, createDataTableColumnHelper, useDataTable, Container } from "/ui"
import { Tier } from "../routes/tiers/page"
...
import { Heading, DataTable, createDataTableColumnHelper, useDataTable, Container, DataTablePaginationState } from "/ui"
import { sdk } from "../lib/sdk"
import { useQuery } from "@tanstack/react-query"
...
import { Modules, OrderStatus } from "/framework/utils"
...
import { updateCartPromotionsWorkflow } from "/medusa/core-flows"
import { AcmeKitError } from "/framework/utils"
import { PromotionActions } from "/framework/utils"
