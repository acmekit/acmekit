  ...
  modules: [
    {
      ...
      options: {
        providers: [
          {
            resolve: "/medusa/notification-sendgrid",
            id: "sendgrid",
            options: {
              channels: ["email"],
...
Medusa provides the second step in its `/medusa/core-flows` package. So, you only need to implement the first one.
...
import { CartDTO, CustomerDTO } from "/framework/types"
...
import { updateCartsStep } from "/medusa/core-flows"
import { CartDTO } from "/framework/types"
