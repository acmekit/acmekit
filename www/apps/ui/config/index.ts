...
export const config: DocsConfig = {
  ...globalConfig,
  titleSuffix: "AcmeKit UI",
  description:
    "Learn about AcmeKit UI, A React package with primitives for building AcmeKit applications. Explore components, hooks, colors, icons, and more.",
  baseUrl,
