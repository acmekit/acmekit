...
import { IFulfillmentModuleService, StockLocationDTO } from "@acmekit/types"
...
acmekitIntegrationTestRunner({
  ...
  testSuite: ({ getContainer, api, dbConnection }) => {
    ...
    /**
     * The test runner run both the acmekit migrations as well as the modules
    ...
    describe("Fulfillment module migrations backward compatibility", () => {
      it("should allow to create a full data structure after the backward compatible migration have run on top of the acmekit v1 database", async () => {
