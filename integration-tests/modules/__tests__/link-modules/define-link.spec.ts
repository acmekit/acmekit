...
import CurrencyModule from "@acmekit/currency"
import { AcmeKitModule } from "@acmekit/modules-sdk"
import ProductModule from "@acmekit/product"
import RegionModule from "@acmekit/region"
  ...
  testSuite: ({ getContainer }) => {
    describe("defineLink", () => {
      it("should generate a proper link definition", async () => {
        ...
        const linkDefinition = AcmeKitModule.getCustomLinks()
