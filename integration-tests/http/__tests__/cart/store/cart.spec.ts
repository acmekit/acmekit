...
import { acmekitTshirtProduct } from "../../../__fixtures__/product"
import {
  createWorkflow,
  WorkflowResponse,
    ...
    describe("Store Carts API", () => {
      ...
      beforeEach(async () => {
        ...
        product = (
          await api.post(
            "/admin/products",
            { ...acmekitTshirtProduct, shipping_profile_id: shippingProfile.id },
            adminHeaders
          )
        ).data.product
      ...
      describe("POST /store/carts", () => {
        ...
        it("should successfully create a cart with a line item with quantity and calculate prices based on the correct quantity", async () => {
          const productData = {
            title: "AcmeKit T-Shirt based quantity",
            ...
            expect.objectContaining({
              ...
              items: [
                expect.objectContaining({
                  ...
                  product_title: "AcmeKit T-Shirt based quantity",
                  product_type: null,
          ...
          it("should only apply promotion on discountable items", async () => {
            const notDiscountableProduct = (
              await api.post(
                "/admin/products",
                {
                  title: "AcmeKit T-Shirt not discountable",
                  status: ProductStatus.PUBLISHED,
