  ...
  overrides: [
    {
      ...
      parserOptions: {
        project: [
          ...
          path.join(__dirname, "./packages/cli/create-acmekit-app/tsconfig.json"),
          path.join(__dirname, "./packages/cli/acmekit-cli/tsconfig.json"),
          path.join(__dirname, "./packages/cli/acmekit-dev-cli/tsconfig.json"),
          path.join(__dirname, "./packages/cli/oas/acmekit-oas-cli/tsconfig.json"),
          ...
          path.join(__dirname, "./packages/acmekit/tsconfig.json"),

          path.join(__dirname, "./packages/acmekit-telemetry/tsconfig.json"),
          path.join(__dirname, "./packages/acmekit-test-utils/tsconfig.json"),
