...
async function subscribersLoader(
  ...
  const pluginSubscribersSourcePaths = [
    /**
     * Load subscribers from the acmekit/acmekit package. Remove once the acmekit core is converted to a plugin
     */
...
async function jobsLoader(
  ...
  const pluginJobSourcePaths = [
    /**
     * Load jobs from the acmekit/acmekit package. Remove once the acmekit core is converted to a plugin
     */
    join(__dirname, "../jobs"),
...
export async function initializeContainer(
  ...
  const configDir = await configLoader(rootDirectory, "acmekit-config", {
