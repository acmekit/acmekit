import { createProductVariantsWorkflow } from "@acmekit/core-flows"
...
import { refetchEntities, refetchEntity } from "@acmekit/framework/http"
import {
  remapKeysForProduct,
  remapKeysForVariant,
...
export const GET = async (
  req: AuthenticatedAcmeKitRequest<HttpTypes.AdminProductVariantParams>,
  res: AcmeKitResponse<HttpTypes.AdminProductVariantListResponse>
) => {
