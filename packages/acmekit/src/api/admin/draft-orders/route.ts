...
export const GET = async (
  req: AcmeKitRequest<HttpTypes.AdminOrderFilters>,
  res: AcmeKitResponse<HttpTypes.AdminDraftOrderListResponse>
) => {
  const variables = {
    filters: {
...
export const POST = async (
  ...
  >,
  res: AcmeKitResponse<HttpTypes.AdminDraftOrderResponse>
) => {
