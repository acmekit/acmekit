import { createRegionsWorkflow } from "@acmekit/core-flows"
...
export const GET = async (
  req: AuthenticatedAcmeKitRequest<HttpTypes.AdminRegionFilters>,
  res: AcmeKitResponse<HttpTypes.AdminRegionListResponse>
) => {
