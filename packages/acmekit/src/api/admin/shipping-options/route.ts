import { createShippingOptionsWorkflow } from "@acmekit/core-flows"
...
export const GET = async (
  req: AuthenticatedAcmeKitRequest<HttpTypes.AdminShippingOptionListParams>,
  res: AcmeKitResponse<HttpTypes.AdminShippingOptionListResponse>
) => {
