import { completeCartWorkflowId } from "@acmekit/core-flows"
import { prepareRetrieveQuery } from "@acmekit/framework"
...
export const POST = async (
  ...
  res: AcmeKitResponse<HttpTypes.StoreCompleteCartResponse>
) => {
  ...
  if (errors?.[0]) {
    ...
    const statusOKErrors: string[] = [
      ...
      AcmeKitError.Types.PAYMENT_AUTHORIZATION_ERROR,
      AcmeKitError.Types.PAYMENT_REQUIRES_MORE_ERROR,
    ]
