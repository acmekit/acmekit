...
export function instrumentHttpLayer() {
  ...
  const HTTPTracer = new Tracer("@acmekit/http", "2.0.0")
...
export function instrumentRemoteQuery() {
  const QueryTracer = new Tracer("@acmekit/query", "2.0.0")
...
export function instrumentWorkflows() {
  const WorkflowsTracer = new Tracer(
    "@acmekit/framework/workflows-sdk",
    "2.0.0"
  )
...
export function instrumentCache() {
  ...
  const CacheTracer = new Tracer("@acmekit/caching", "2.0.0")
