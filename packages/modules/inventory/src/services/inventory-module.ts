...
type InjectedDependencies = {
  ...
  inventoryItemService: ModulesSdkTypes.IAcmeKitInternalService<any>
  inventoryLevelService: InventoryLevelService
  reservationItemService: ModulesSdkTypes.IAcmeKitInternalService<any>
}
  ...
  implements IInventoryService
{
  ...
  protected readonly inventoryItemService_: ModulesSdkTypes.IAcmeKitInternalService<
    typeof InventoryItem
  >
  protected readonly reservationItemService_: ModulesSdkTypes.IAcmeKitInternalService<
  ...
  private async ensureInventoryLevels(
    ...
    if (missing.length) {
      ...
      throw new AcmeKitError(AcmeKitError.Types.NOT_FOUND, error)
    }
