...
type InjectedDependencies = {
  ...
  fulfillmentAddressService: ModulesSdkTypes.IAcmeKitInternalService<any>
  fulfillmentSetService: ModulesSdkTypes.IAcmeKitInternalService<any>
  serviceZoneService: ModulesSdkTypes.IAcmeKitInternalService<any>
  geoZoneService: ModulesSdkTypes.IAcmeKitInternalService<any>
  shippingProfileService: ModulesSdkTypes.IAcmeKitInternalService<any>
  shippingOptionService: ModulesSdkTypes.IAcmeKitInternalService<any>
  shippingOptionRuleService: ModulesSdkTypes.IAcmeKitInternalService<any>
  shippingOptionTypeService: ModulesSdkTypes.IAcmeKitInternalService<any>
  fulfillmentProviderService: FulfillmentProviderService
  fulfillmentService: ModulesSdkTypes.IAcmeKitInternalService<any>
  logger?: Logger
}
  ...
  implements IFulfillmentModuleService
{
  ...
  protected readonly fulfillmentSetService_: ModulesSdkTypes.IAcmeKitInternalService<
    InferEntityType<typeof FulfillmentSet>
  >
  protected readonly serviceZoneService_: ModulesSdkTypes.IAcmeKitInternalService<
    InferEntityType<typeof ServiceZone>
  >
  protected readonly geoZoneService_: ModulesSdkTypes.IAcmeKitInternalService<
    InferEntityType<typeof GeoZone>
  >
  protected readonly shippingProfileService_: ModulesSdkTypes.IAcmeKitInternalService<
    InferEntityType<typeof ShippingProfile>
  >
  protected readonly shippingOptionService_: ModulesSdkTypes.IAcmeKitInternalService<
    InferEntityType<typeof ShippingOption>
  >
  protected readonly shippingOptionRuleService_: ModulesSdkTypes.IAcmeKitInternalService<
    InferEntityType<typeof ShippingOptionRule>
  >
  protected readonly shippingOptionTypeService_: ModulesSdkTypes.IAcmeKitInternalService<
    InferEntityType<typeof ShippingOptionType>
  >
  protected readonly fulfillmentProviderService_: FulfillmentProviderService
  protected readonly fulfillmentService_: ModulesSdkTypes.IAcmeKitInternalService<
  ...
  protected static buildGeoZoneConstraintsFromAddress(
     ...
     * to this pr https://github.com/acmekit/acmekit/pull/8066
     */
