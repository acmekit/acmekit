...
type InjectedDependencies = {
  ...
  stockLocationService: ModulesSdkTypes.IAcmeKitInternalService<any>
  stockLocationAddressService: ModulesSdkTypes.IAcmeKitInternalService<any>
}
  ...
  implements IStockLocationService
{
  ...
  protected readonly stockLocationService_: ModulesSdkTypes.IAcmeKitInternalService<
    InferEntityType<typeof StockLocation>
  >
  protected readonly stockLocationAddressService_: ModulesSdkTypes.IAcmeKitInternalService<
