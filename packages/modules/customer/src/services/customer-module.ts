...
type InjectedDependencies = {
  ...
  customerService: ModulesSdkTypes.IAcmeKitInternalService<any>
  customerAddressService: ModulesSdkTypes.IAcmeKitInternalService<any>
  customerGroupService: ModulesSdkTypes.IAcmeKitInternalService<any>
  customerGroupCustomerService: ModulesSdkTypes.IAcmeKitInternalService<any>
}
  ...
  implements ICustomerModuleService
{
  ...
  protected customerService_: ModulesSdkTypes.IAcmeKitInternalService<
    InferEntityType<typeof Customer>
  >
  protected customerAddressService_: ModulesSdkTypes.IAcmeKitInternalService<
    InferEntityType<typeof CustomerAddress>
  >
  protected customerGroupService_: ModulesSdkTypes.IAcmeKitInternalService<
    InferEntityType<typeof CustomerGroup>
  >
  protected customerGroupCustomerService_: ModulesSdkTypes.IAcmeKitInternalService<
