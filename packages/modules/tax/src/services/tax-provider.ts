import { DAL, ITaxProvider, Logger, TaxTypes } from "@acmekit/framework/types"
...
export default class TaxProviderService extends ModulesSdkUtils.AcmeKitInternalService<InjectedDependencies>(
  TaxProvider
) {
  #logger: Logger
