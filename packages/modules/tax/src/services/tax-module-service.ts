...
type InjectedDependencies = {
  ...
  taxRateService: ModulesSdkTypes.IAcmeKitInternalService<any>
  taxRegionService: ModulesSdkTypes.IAcmeKitInternalService<any>
  taxRateRuleService: ModulesSdkTypes.IAcmeKitInternalService<any>
  ...
  implements ITaxModuleService
{
  ...
  protected taxRateService_: ModulesSdkTypes.IAcmeKitInternalService<
    InferEntityType<typeof TaxRate>
  >
  protected taxRegionService_: ModulesSdkTypes.IAcmeKitInternalService<
    InferEntityType<typeof TaxRegion>
  >
  protected taxRateRuleService_: ModulesSdkTypes.IAcmeKitInternalService<
