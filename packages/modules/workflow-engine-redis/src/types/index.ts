...
declare module "@acmekit/types" {
  interface ModuleOptions {
    "@acmekit/workflow-engine-redis": RedisWorkflowsOptions
    "@acmekit/acmekit/workflow-engine-redis": RedisWorkflowsOptions
  }
}
