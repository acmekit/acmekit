...
type InjectedDependencies = {
  ...
  cartService: ModulesSdkTypes.IAcmeKitInternalService<any>
  addressService: ModulesSdkTypes.IAcmeKitInternalService<any>
  lineItemService: ModulesSdkTypes.IAcmeKitInternalService<any>
  shippingMethodAdjustmentService: ModulesSdkTypes.IAcmeKitInternalService<any>
  shippingMethodService: ModulesSdkTypes.IAcmeKitInternalService<any>
  lineItemAdjustmentService: ModulesSdkTypes.IAcmeKitInternalService<any>
  lineItemTaxLineService: ModulesSdkTypes.IAcmeKitInternalService<any>
  shippingMethodTaxLineService: ModulesSdkTypes.IAcmeKitInternalService<any>
}
  ...
  implements ICartModuleService
{
  ...
  protected cartService_: ModulesSdkTypes.IAcmeKitInternalService<
    InferEntityType<typeof Cart>
  >
  protected addressService_: ModulesSdkTypes.IAcmeKitInternalService<
    InferEntityType<typeof Address>
  >
  protected lineItemService_: ModulesSdkTypes.IAcmeKitInternalService<
    InferEntityType<typeof LineItem>
  >
  protected shippingMethodAdjustmentService_: ModulesSdkTypes.IAcmeKitInternalService<
    InferEntityType<typeof ShippingMethodAdjustment>
  >
  protected shippingMethodService_: ModulesSdkTypes.IAcmeKitInternalService<
    InferEntityType<typeof ShippingMethod>
  >
  protected lineItemAdjustmentService_: ModulesSdkTypes.IAcmeKitInternalService<
    InferEntityType<typeof LineItemAdjustment>
  >
  protected lineItemTaxLineService_: ModulesSdkTypes.IAcmeKitInternalService<
    InferEntityType<typeof LineItemTaxLine>
  >
  protected shippingMethodTaxLineService_: ModulesSdkTypes.IAcmeKitInternalService<
