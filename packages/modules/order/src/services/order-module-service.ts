import { BeforeCreate, OnInit } from "@acmekit/framework/mikro-orm/core"
import {
  BigNumberInput,
  Context,
...
type InjectedDependencies = {
  ...
  orderAddressService: ModulesSdkTypes.IAcmeKitInternalService<any>
  orderLineItemService: ModulesSdkTypes.IAcmeKitInternalService<any>
  orderShippingMethodAdjustmentService: ModulesSdkTypes.IAcmeKitInternalService<any>
  orderShippingMethodService: ModulesSdkTypes.IAcmeKitInternalService<any>
  orderLineItemAdjustmentService: ModulesSdkTypes.IAcmeKitInternalService<any>
  orderLineItemTaxLineService: ModulesSdkTypes.IAcmeKitInternalService<any>
  orderShippingMethodTaxLineService: ModulesSdkTypes.IAcmeKitInternalService<any>
  orderTransactionService: ModulesSdkTypes.IAcmeKitInternalService<any>
  orderChangeService: ModulesSdkTypes.IAcmeKitInternalService<any>
  orderChangeActionService: ModulesSdkTypes.IAcmeKitInternalService<any>
  orderItemService: ModulesSdkTypes.IAcmeKitInternalService<any>
  orderSummaryService: ModulesSdkTypes.IAcmeKitInternalService<any>
  orderShippingService: ModulesSdkTypes.IAcmeKitInternalService<any>
  returnReasonService: ModulesSdkTypes.IAcmeKitInternalService<any>
  returnService: ModulesSdkTypes.IAcmeKitInternalService<any>
  returnItemService: ModulesSdkTypes.IAcmeKitInternalService<any>
  orderClaimService: ModulesSdkTypes.IAcmeKitInternalService<any>
  orderExchangeService: ModulesSdkTypes.IAcmeKitInternalService<any>
  orderCreditLineService: ModulesSdkTypes.IAcmeKitInternalService<any>
}
  ...
  implements IOrderModuleService
{
  ...
  protected orderAddressService_: ModulesSdkTypes.IAcmeKitInternalService<
    InferEntityType<typeof OrderAddress>
  >
  protected orderLineItemService_: ModulesSdkTypes.IAcmeKitInternalService<
    InferEntityType<typeof OrderLineItem>
  >
  protected orderShippingMethodAdjustmentService_: ModulesSdkTypes.IAcmeKitInternalService<
    InferEntityType<typeof OrderShippingMethodAdjustment>
  >
  protected orderShippingMethodService_: ModulesSdkTypes.IAcmeKitInternalService<
    InferEntityType<typeof OrderShippingMethod>
  >
  protected orderLineItemAdjustmentService_: ModulesSdkTypes.IAcmeKitInternalService<
    InferEntityType<typeof OrderLineItemAdjustment>
  >
  protected orderLineItemTaxLineService_: ModulesSdkTypes.IAcmeKitInternalService<
    InferEntityType<typeof OrderLineItemTaxLine>
  >
  protected orderShippingMethodTaxLineService_: ModulesSdkTypes.IAcmeKitInternalService<
    InferEntityType<typeof OrderShippingMethodTaxLine>
  >
  protected orderTransactionService_: ModulesSdkTypes.IAcmeKitInternalService<
    InferEntityType<typeof OrderTransaction>
  >
  protected orderChangeService_: ModulesSdkTypes.IAcmeKitInternalService<
    InferEntityType<typeof OrderChange>
  >
  protected orderChangeActionService_: ModulesSdkTypes.IAcmeKitInternalService<
    InferEntityType<typeof OrderChangeAction>
  >
  protected orderItemService_: ModulesSdkTypes.IAcmeKitInternalService<
    InferEntityType<typeof OrderItem>
  >
  protected orderSummaryService_: ModulesSdkTypes.IAcmeKitInternalService<
    InferEntityType<typeof OrderSummary>
  >
  protected orderShippingService_: ModulesSdkTypes.IAcmeKitInternalService<
    InferEntityType<typeof OrderShipping>
  >
  protected returnReasonService_: ModulesSdkTypes.IAcmeKitInternalService<
    InferEntityType<typeof ReturnReason>
  >
  protected returnService_: ModulesSdkTypes.IAcmeKitInternalService<
    InferEntityType<typeof Return>
  >
  protected returnItemService_: ModulesSdkTypes.IAcmeKitInternalService<
    InferEntityType<typeof ReturnItem>
  >
  protected orderClaimService_: ModulesSdkTypes.IAcmeKitInternalService<
    InferEntityType<typeof OrderClaim>
  >
  protected orderClaimItemService_: ModulesSdkTypes.IAcmeKitInternalService<
    InferEntityType<typeof OrderClaimItem>
  >
  protected orderClaimItemImageService_: ModulesSdkTypes.IAcmeKitInternalService<
    InferEntityType<typeof OrderClaimItemImage>
  >
  protected orderExchangeService_: ModulesSdkTypes.IAcmeKitInternalService<
    InferEntityType<typeof OrderExchange>
  >
  protected orderExchangeItemService_: ModulesSdkTypes.IAcmeKitInternalService<
    InferEntityType<typeof OrderExchangeItem>
  >
  protected orderCreditLineService_: ModulesSdkTypes.IAcmeKitInternalService<
  ...
  protected async listOrders_(
    filters?: any,
    config?: FindConfig<any> | undefined,
    @AcmeKitContext() sharedContext?: Context | undefined
  ): Promise<OrderTypes.OrderDTO[]> {
    config ??= {}
    const includeTotals = this.shouldIncludeTotals(config)
