  ...
  implements SettingsTypes.ISettingsModuleService
{
  ...
  protected readonly viewConfigurationService_: ModulesSdkTypes.IAcmeKitInternalService<
    InferEntityType<typeof ViewConfiguration>
  >
  protected readonly userPreferenceService_: ModulesSdkTypes.IAcmeKitInternalService<
