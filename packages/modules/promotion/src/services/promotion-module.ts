...
type InjectedDependencies = {
  ...
  promotionService: ModulesSdkTypes.IAcmeKitInternalService<any>
  applicationMethodService: ModulesSdkTypes.IAcmeKitInternalService<any>
  promotionRuleService: ModulesSdkTypes.IAcmeKitInternalService<any>
  promotionRuleValueService: ModulesSdkTypes.IAcmeKitInternalService<any>
  campaignService: ModulesSdkTypes.IAcmeKitInternalService<any>
  campaignBudgetService: ModulesSdkTypes.IAcmeKitInternalService<any>
  campaignBudgetUsageService: ModulesSdkTypes.IAcmeKitInternalService<any>
}
  ...
  implements PromotionTypes.IPromotionModuleService
{
  ...
  protected promotionService_: ModulesSdkTypes.IAcmeKitInternalService<
    InferEntityType<typeof Promotion>
  >
  protected applicationMethodService_: ModulesSdkTypes.IAcmeKitInternalService<
    InferEntityType<typeof ApplicationMethod>
  >
  protected promotionRuleService_: ModulesSdkTypes.IAcmeKitInternalService<
    InferEntityType<typeof PromotionRule>
  >
  protected promotionRuleValueService_: ModulesSdkTypes.IAcmeKitInternalService<
    InferEntityType<typeof PromotionRuleValue>
  >
  protected campaignService_: ModulesSdkTypes.IAcmeKitInternalService<
    InferEntityType<typeof Campaign>
  >
  protected campaignBudgetService_: ModulesSdkTypes.IAcmeKitInternalService<
    InferEntityType<typeof CampaignBudget>
  >

  protected campaignBudgetUsageService_: ModulesSdkTypes.IAcmeKitInternalService<
   ...
   * @returns void
   * @throws {AcmeKitError} - If the promotion usage exceeds the budget limit.
   */
  async registerUsage(
