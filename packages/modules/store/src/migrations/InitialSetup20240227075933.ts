...
export class InitialSetup20240226130829 extends Migration {
  async up(): Promise<void> {
    ...
    if (storeTables.length > 0) {
      ...
      this.addSql(
        `alter table "store" alter column "name" SET DEFAULT 'AcmeKit Store';`
      )
      this.addSql(
      ...
      ("id" text not null, "name" text not null default \'AcmeKit Store\', "supported_currency_codes" text[] not null default \'{}\',
