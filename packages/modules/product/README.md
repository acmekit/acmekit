...
[Product Module documentation](https://docs.acmekit.com/v2/resources/commerce-modules/product) | [AcmeKit Website](https://acmekit.com/) | [AcmeKit Repository](https://github.com/acmekit/acmekit)
...
> If you are using an existing AcmeKit database, you can skip this step. This step is only applicable when the module is used in isolation from a full AcmeKit setup
...
"scripts": {
    //...other scripts
    "product:migrations:run": "acmekit-product-migrations-up",
    "product:seed": "acmekit-product-seed ./seed-data.js"
},
```
...
const nextConfig = {
  experimental: {
    serverComponentsExternalPackages: ["@acmekit/product"],
  },
}
...
import { initialize as initializeProductModule } from "@acmekit/product"
...
Then, open in your browser the URL `http://localhost:3000/api/products`. If you seeded your database with demo products, or you’re using a AcmeKit database schema, you’ll receive the products in your database. Otherwise, the request will return an empty array.
