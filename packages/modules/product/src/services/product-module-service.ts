...
type InjectedDependencies = {
  ...
  productService: ModulesSdkTypes.IAcmeKitInternalService<any, any>
  productVariantService: ModulesSdkTypes.IAcmeKitInternalService<any, any>
  productTagService: ModulesSdkTypes.IAcmeKitInternalService<any>
  productCategoryService: ProductCategoryService
  productCollectionService: ModulesSdkTypes.IAcmeKitInternalService<any>
  productImageService: ModulesSdkTypes.IAcmeKitInternalService<any>
  productImageProductService: ModulesSdkTypes.IAcmeKitInternalService<any>
  productTypeService: ModulesSdkTypes.IAcmeKitInternalService<any>
  productOptionService: ModulesSdkTypes.IAcmeKitInternalService<any>
  productOptionValueService: ModulesSdkTypes.IAcmeKitInternalService<any>
  productVariantProductImageService: ModulesSdkTypes.IAcmeKitInternalService<any>
  ...
  implements ProductTypes.IProductModuleService
{
  ...
  protected readonly productService_: ModulesSdkTypes.IAcmeKitInternalService<
    InferEntityType<typeof Product>
  >
  protected readonly productVariantService_: ModulesSdkTypes.IAcmeKitInternalService<
    InferEntityType<typeof ProductVariant>
  >
  protected readonly productCategoryService_: ProductCategoryService
  protected readonly productTagService_: ModulesSdkTypes.IAcmeKitInternalService<
    InferEntityType<typeof ProductTag>
  >
  protected readonly productCollectionService_: ModulesSdkTypes.IAcmeKitInternalService<
    InferEntityType<typeof ProductCollection>
  >
  protected readonly productImageService_: ModulesSdkTypes.IAcmeKitInternalService<
    InferEntityType<typeof ProductImage>
  >
  protected readonly productTypeService_: ModulesSdkTypes.IAcmeKitInternalService<
    InferEntityType<typeof ProductType>
  >
  protected readonly productOptionService_: ModulesSdkTypes.IAcmeKitInternalService<
    InferEntityType<typeof ProductOption>
  >
  protected readonly productOptionValueService_: ModulesSdkTypes.IAcmeKitInternalService<
    InferEntityType<typeof ProductOptionValue>
  >
  protected readonly productVariantProductImageService_: ModulesSdkTypes.IAcmeKitInternalService<
  ...
  protected async updateProducts_(
    ...
    const subscriber = createAcmeKitMikroOrmEventSubscriber(
      ["updateProducts_"],
      this as unknown as ReturnType<typeof AcmeKitService<any>>
    )
  ...
  > {
    ...
    // arguments. Therefore, applying the AcmeKitContext() decorator to the function will not work
