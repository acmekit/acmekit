import { AcmeKitContainer } from "@acmekit/framework"
import { asFunction } from "@acmekit/framework/awilix"
import {
...
moduleIntegrationTestRunner<IWorkflowEngineService>({
  ...
  resolve: __dirname + "/../..",
  testSuite: ({ service: workflowOrcModule, acmekitApp }) => {
    describe("Workflow Orchestrator module", function () {
      let query: RemoteQueryFunction
      let sharedContainer_: AcmeKitContainer

      beforeEach(() => {
        query = acmekitApp.query
        sharedContainer_ = acmekitApp.sharedContainer
      })
