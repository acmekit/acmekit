...
import { Collection } from "@acmekit/framework/mikro-orm/core"
...
type InjectedDependencies = {
  ...
  priceSetService: ModulesSdkTypes.IAcmeKitInternalService<any>
  priceRuleService: ModulesSdkTypes.IAcmeKitInternalService<any>
  priceService: ModulesSdkTypes.IAcmeKitInternalService<any>
  priceListService: ModulesSdkTypes.IAcmeKitInternalService<any>
  pricePreferenceService: ModulesSdkTypes.IAcmeKitInternalService<any>
  priceListRuleService: ModulesSdkTypes.IAcmeKitInternalService<any>
}
...
const BaseClass = ModulesSdkUtils.AcmeKitService<{
...
{
  protected readonly container_: AcmeKitContainer
  protected baseRepository_: DAL.RepositoryService
  protected readonly pricingRepository_: PricingRepositoryService & {
    clearAvailableAttributes?: () => Promise<void>
  }
  protected readonly priceSetService_: ModulesSdkTypes.IAcmeKitInternalService<
    InferEntityType<typeof PriceSet>
  >
  protected readonly priceRuleService_: ModulesSdkTypes.IAcmeKitInternalService<
    InferEntityType<typeof PriceRule>
  >
  protected readonly priceService_: ModulesSdkTypes.IAcmeKitInternalService<
    InferEntityType<typeof Price>
  >
  protected readonly priceListService_: ModulesSdkTypes.IAcmeKitInternalService<
    InferEntityType<typeof PriceList>
  >
  protected readonly priceListRuleService_: ModulesSdkTypes.IAcmeKitInternalService<
    InferEntityType<typeof PriceListRule>
  >
  protected readonly pricePreferenceService_: ModulesSdkTypes.IAcmeKitInternalService<
