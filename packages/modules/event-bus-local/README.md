...
The Node EventEmitter is limited to a single process environment. We generally recommend using the `/event-bus-redis` module in a production environment.
