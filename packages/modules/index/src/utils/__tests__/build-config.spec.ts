...
jest.mock("@acmekit/framework/modules-sdk", () => ({
  AcmeKitModule: {
    getAllJoinerConfigs: jest.fn(),
  },
}))

// No need to mock @acmekit/framework/utils since we're using the actual implementations
...
describe("buildSchemaObjectRepresentation", () => {
  ...
  beforeEach(() => {
    ...
    // Mock AcmeKitModule.getAllJoinerConfigs
    ;(AcmeKitModule.getAllJoinerConfigs as jest.Mock).mockReturnValue([])
  })
