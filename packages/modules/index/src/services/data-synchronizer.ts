...
export class DataSynchronizer {
  ...
  get #indexMetadataService(): ModulesSdkTypes.IAcmeKitInternalService<any> {
    return this.#container.indexMetadataService
  }

  get #indexSyncService(): ModulesSdkTypes.IAcmeKitInternalService<any> {
    return this.#container.indexSyncService
  }

  // @ts-ignore
  get #indexRelationService(): ModulesSdkTypes.IAcmeKitInternalService<any> {
