  ...
  implements IndexTypes.IIndexService
{
  ...
  private get indexMetadataService_(): ModulesSdkTypes.IAcmeKitInternalService<any> {
    return this.container_.indexMetadataService
  }

  private get indexSyncService_(): ModulesSdkTypes.IAcmeKitInternalService<any> {
