...
import { EventBusTypes, IndexTypes } from "@acmekit/framework/types"
import {
...
const beforeAll_ = async () => {
  try {
    ...
    acmekitAppLoader = new AcmeKitAppLoader(container as any)
...
describe("IndexModuleService", function () {
  ...
  describe("on created or attached events", function () {
    ...
    beforeEach(async () => {
      ...
      manager = (acmekitApp.sharedContainer!.resolve(Modules.INDEX) as any)
