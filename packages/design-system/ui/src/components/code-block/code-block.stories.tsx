...
const snippets = [
  ...
  },
  {
    ...
    language: "jsx",
    code: `// Install the JS Client in your storefront project: @acmekit/acmekit-js\n\nimport AcmeKit from "@acmekit/acmekit-js"\n\nconst acmekit = new AcmeKit({ publishableApiKey: "YOUR_API_KEY"})\nconst product = await acmekit.products.retrieve("PRODUCT_ID")\nconsole.log(product.id)`,
  },
  {
    label: "AcmeKit React",
    language: "tsx",
    code: `// Install the React SDK and required dependencies in your storefront project:\n// acmekit-react @tanstack/react-query @acmekit/acmekit\n\nimport { useProduct } from "acmekit-react"\n\nconst { product } = useProduct("PRODUCT_ID")\nconsole.log(product.id)`,
  },
]
