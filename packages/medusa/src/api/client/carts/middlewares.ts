...
export const storeCartRoutesMiddlewares: MiddlewareRoute[] = [
  ...
  {
    method: ["POST"],
    matcher: "/client/carts/:id/customer",
    middlewares: [
  ...
  {
    method: ["POST"],
    matcher: "/client/carts/:id/line-items",
    middlewares: [
  ...
  {
    method: ["POST"],
    matcher: "/client/carts/:id/line-items/:line_id",
    middlewares: [
  ...
  {
    method: ["POST"],
    matcher: "/client/carts/:id/promotions",
    middlewares: [
  ...
  {
    method: ["POST"],
    matcher: "/client/carts/:id/shipping-methods",
    middlewares: [
  ...
  {
    method: ["POST"],
    matcher: "/client/carts/:id/complete",
    middlewares: [
      validateAndTransformQuery(
        StoreGetOrderParams,
