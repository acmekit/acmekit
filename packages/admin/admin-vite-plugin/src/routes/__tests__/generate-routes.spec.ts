...
describe("generateRoutes", () => {
  ...
  it("should handle windows paths", async () => {
    ...
    const result = await generateRoutes(new Set(["C:\\acmekit\\src\\admin"]))
  ...
  it("should handle parallel routes", async () => {
    const mockFiles = [
      "Users/user/acmekit/src/admin/routes/brands/page.tsx",
      "Users/user/acmekit/src/admin/routes/brands/@create/page.tsx",
    ]
    vi.mocked(utils.crawl).mockResolvedValue(mockFiles)
  ...
  it("should handle parallel routes with windows paths", async () => {
    const mockFiles = [
      "C:\\acmekit\\src\\admin\\routes\\brands\\page.tsx",
      "C:\\acmekit\\src\\admin\\routes\\brands\\@create\\page.tsx",
    ]
    vi.mocked(utils.crawl).mockResolvedValue(mockFiles)
