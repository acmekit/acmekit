...
import { PluginProjectCreator } from "./acmekit-plugin-creator.js"
import { AcmeKitProjectCreator } from "./acmekit-project-creator.js"
  ...
  const { projectName } = await inquirer.prompt([
    {
      ...
      default: isPlugin ? "my-acmekit-plugin" : "my-acmekit-store",
      filter: (input) => {
