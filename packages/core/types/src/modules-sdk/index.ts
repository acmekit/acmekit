...
export * from "../common/acmekit-container"
...
export type InternalModuleDeclaration = {
  scope: "internal"
  dependencies?: string[]
  definition?: CustomModuleDefinition // That represent the definition of the module, such as the one we have for the acmekit supported modules. This property is used for custom made modules.
