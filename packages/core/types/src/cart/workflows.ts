...
export interface CreateCartCreateLineItemDTO {
   ...
   * [this documentation](https://docs.acmekit.com/resources/commerce-modules/pricing/tax-inclusive-pricing)
   */
...
export interface ConfirmVariantInventoryWorkflowInputDTO {
  ...
  variants: {
    ...
    id: string
    /**
     * Whether AcmeKit manages the inventory of the variant. If disabled, the
