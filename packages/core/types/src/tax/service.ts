...
export interface ITaxModuleService extends IModuleService {
   ...
   *
   * Learn more in [this guide](https://docs.acmekit.com/resources/commerce-modules/tax/tax-calculation-with-provider).
   *
   ...
   * and `id` is the ID set in `acmekit-config.ts` when registering the provider.
   *
