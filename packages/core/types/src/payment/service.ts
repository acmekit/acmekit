...
export interface IPaymentModuleService extends IModuleService {
   ...
   *
   * Learn more about the payment flow in [this guide](https://docs.acmekit.com/resources/commerce-modules/payment/payment-flow)
   *
   ...
   *
   * Learn more about handling webhook events in [this guide](https://docs.acmekit.com/resources/commerce-modules/payment/webhook-events)
   *
   ...
   *
   * @example
   * In the following example, `req` is an instance of `AcmeKitRequest`:
   *
   * ```ts
