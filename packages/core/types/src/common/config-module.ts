...
export type ProjectConfigOptions = {
   ...
   *
   * ![Diagram showcasing how the server and worker work together](https://res.cloudinary.com/dza7lstvk/image/upload/fl_lossy/f_auto/r_16/ar_16:9,c_pad/v1/AcmeKit%20Book/acmekit-worker_klkbch.jpg?_a=BATFJtAA0)
   *
