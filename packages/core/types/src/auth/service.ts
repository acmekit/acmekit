...
export interface IAuthModuleService extends IModuleService {
   ...
   *
   * Refer to [this guide](https://docs.acmekit.com/resources/commerce-modules/auth/authentication-route) to learn more about the authentication flows.
   *
   ...
   * `req` is an instance of the `AcmeKitRequest` object:
   *
   * ```ts
   ...
   *
   * Learn more about this authentication flow in [this guide](https://docs.acmekit.com/resources/commerce-modules/auth/authentication-route#2-third-party-service-authenticate-flow).
   *
