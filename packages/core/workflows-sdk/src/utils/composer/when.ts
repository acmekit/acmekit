import { isDefined, isObject, OrchestrationUtils } from "@acmekit/utils"
...
export function when(...args) {
  ...
  global[OrchestrationUtils.SymbolAcmeKitWorkflowComposerCondition] = {
    input,
    condition,
    steps: [],
  }
  ...
  return {
    then: (fn) => {
      ...
      const applyCondition =
        global[OrchestrationUtils.SymbolAcmeKitWorkflowComposerCondition].steps
      ...
      delete global[OrchestrationUtils.SymbolAcmeKitWorkflowComposerCondition]
