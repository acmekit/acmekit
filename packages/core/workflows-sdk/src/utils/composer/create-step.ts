...
>): StepFunctionResult<TInvokeResultOutput> {
  return function (this: CreateWorkflowComposerContext) {
    ...
    refRet.config = (
      ...
      if (global[OrchestrationUtils.SymbolAcmeKitWorkflowComposerCondition]) {
        const flagSteps =
    ...
    if (global[OrchestrationUtils.SymbolAcmeKitWorkflowComposerCondition]) {
      global[
        OrchestrationUtils.SymbolAcmeKitWorkflowComposerCondition
      ].steps.push(refRet)
    }
...
>(
  ...
  const returnFn = function (
    ...
    const context = global[
      OrchestrationUtils.SymbolAcmeKitWorkflowComposerContext
