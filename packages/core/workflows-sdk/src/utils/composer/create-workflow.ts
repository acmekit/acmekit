...
> {
  ...
  const context: CreateWorkflowComposerContext = {
    __type: OrchestrationUtils.SymbolAcmeKitWorkflowComposerContext,
    workflowId: name,
  ...
  global[OrchestrationUtils.SymbolAcmeKitWorkflowComposerContext] = context
  ...
  delete global[OrchestrationUtils.SymbolAcmeKitWorkflowComposerContext]
