...
export class Notification {
   ...
   * [Get Notification](https://docs.acmekit.com/api/admin#notifications_getnotificationsid)
   * API route.
   * 
   ...
   * [List Notifications](https://docs.acmekit.com/api/admin#notifications_getnotifications)
   * API route.
   * 
