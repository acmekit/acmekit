...
export class Currency {
   ...
   * [List Currencies](https://docs.acmekit.com/api/admin#currencies_getcurrencies)
   * API route.
   * 
   ...
   * [Get Currency](https://docs.acmekit.com/api/admin#currencies_getcurrenciescode) API route.
   * 
