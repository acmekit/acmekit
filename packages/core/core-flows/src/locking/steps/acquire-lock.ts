...
export interface AcquireLockStepInput {
   ...
   * (in-memory or the provider configured in acmekit-config.ts) will be used.
   */
  provider?: string
...
/**
 * This step acquires a lock for a given key. Learn more about locks in the [Locking Module](https://docs.acmekit.com/resources/infrastructure-modules/locking)
 * guide.
 *
 * @example
