 ...
 * [Generate Reset Password Token for Admin](https://docs.acmekit.com/api/admin#auth_postactor_typeauth_providerresetpassword)
 * and [Generate Reset Password Token for Customer](https://docs.acmekit.com/api/store#auth_postactor_typeauth_providerresetpassword)
 * API Routes.
 *
 * The workflow emits the `auth.password_reset` event, which you can listen to in
 * a [subscriber](https://docs.acmekit.com/learn/fundamentals/events-and-subscribers). Follow
 * [this guide](https://docs.acmekit.com/resources/commerce-modules/auth/reset-password) to learn
