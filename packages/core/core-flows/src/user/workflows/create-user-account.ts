import type { CreateUserDTO, UserDTO } from "@acmekit/framework/types"
import {
  WorkflowData,
  WorkflowResponse,
  createWorkflow,
 ...
 *
 * You can create an auth identity first using the [Retrieve Registration JWT Token API Route](https://docs.acmekit.com/api/admin#auth_postactor_typeauth_provider_register).
