 ...
 * [Export Products Admin API Route](https://docs.acmekit.com/api/admin#products_postproductsexport).
 *
 * :::note
 *
 * This workflow doesn't return the exported products. Instead, it sends a notification to the admin
 * users that they can download the exported products. Learn more in the [API Reference](https://docs.acmekit.com/api/admin#products_postproductsexport).
 *
 * :::
 *
 * @example
