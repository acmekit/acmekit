...
import { ProductCollectionWorkflowEvents } from "@acmekit/framework/utils"
import {
  WorkflowData,
  WorkflowResponse,
  createHook,
 ...
 * [Create Collection Admin API Route](https://docs.acmekit.com/api/admin#collections_postcollectionsid).
 *
