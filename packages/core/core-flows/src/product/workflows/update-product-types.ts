...
import { ProductTypeWorkflowEvents } from "@acmekit/framework/utils"
import {
  WorkflowData,
  WorkflowResponse,
  createHook,
 ...
 * [Update Product Type Admin API Route](https://docs.acmekit.com/api/admin#product-types_postproducttypesid).
 *
