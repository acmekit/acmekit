...
import { ProductTypes } from "@acmekit/framework/types"
import {
 ...
 * It's used by the [Batch Image Variants Admin API Route](https://docs.acmekit.com/api/admin#products_postproductsidimagesimage_idvariantsbatch).
 *
 ...
 * This is also useful when writing a [seed script](https://docs.acmekit.com/learn/fundamentals/custom-cli-scripts/seed-data) or a custom import script.
 *
 * @since 2.11.2
 *
 * @example
