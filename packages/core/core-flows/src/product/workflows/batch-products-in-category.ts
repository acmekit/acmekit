import type { ProductCategoryWorkflow } from "@acmekit/framework/types"
 ...
 * [Manage Products of Category Admin API Route](https://docs.acmekit.com/api/admin#product-categories_postproductcategoriesidproducts).
 *
