import type { WorkflowTypes } from "@acmekit/framework/types"
import {
  WorkflowData,
  WorkflowResponse,
  createWorkflow,
 ...
 * [Import Products Admin API Route](https://docs.acmekit.com/api/admin#products_postproductsimport).
 *
 ...
 *
 * The workflow only starts the import, but you'll have to confirm it using the [Workflow Engine](https://docs.acmekit.com/resources/infrastructure-modules/workflow-engine).
 ...
 *
 * You confirm the import using the [Workflow Engine](https://docs.acmekit.com/resources/infrastructure-modules/workflow-engine).
 ...
 * import type { IWorkflowEngineService } from "@acmekit/framework/types"
 ...
 * :::tip
 *
 * This example API route uses the same implementation as the [Confirm Product Import Admin API Route](https://docs.acmekit.com/api/admin#products_postproductsimportstransaction_idconfirm).
 *
 * :::
 *
 * @summary
