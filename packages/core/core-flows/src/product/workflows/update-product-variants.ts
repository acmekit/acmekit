...
import { ProductVariantWorkflowEvents } from "@acmekit/framework/utils"
import {
  WorkflowData,
  WorkflowResponse,
  createHook,
...
/**
 * This workflow updates one or more product variants. It's used by the [Update Product Variant Admin API Route](https://docs.acmekit.com/api/admin#products_postproductsidvariantsvariant_id).
 *
