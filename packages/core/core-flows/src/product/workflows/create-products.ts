...
/**
 * This workflow creates one or more products. It's used by the [Create Product Admin API Route](https://docs.acmekit.com/api/admin#products_postproducts).
 * It can also be useful to you when creating [seed scripts](https://docs.acmekit.com/learn/fundamentals/custom-cli-scripts/seed-data), for example.
 *
 * This workflow has a hook that allows you to perform custom actions on the created products. You can see an example in [this guide](https://docs.acmekit.com/resources/commerce-modules/product/extend).
 *
 ...
 * [Price Rules](https://docs.acmekit.com/resources/commerce-modules/pricing/price-rules) documentation.
 * 
 * :::
 *
 * @example
