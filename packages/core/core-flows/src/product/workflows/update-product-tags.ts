...
import { ProductTagWorkflowEvents } from "@acmekit/framework/utils"
import {
  WorkflowData,
  WorkflowResponse,
  createHook,
 ...
 * [Update Product Tag Admin API Route](https://docs.acmekit.com/api/admin#product-tags_postproducttagsid).
 *
