import { Modules, ProductTypeWorkflowEvents } from "@acmekit/framework/utils"
import {
  WorkflowData,
  WorkflowResponse,
  createHook,
 ...
 * [Delete Product Types Admin API Route](https://docs.acmekit.com/api/admin#product-types_deleteproducttypesid).
 *
