 ...
 * [Manage Variants in a Product Admin API Route](https://docs.acmekit.com/api/admin#products_postproductsidvariantsbatch).
 * 
 ...
 * use this within a [seed script](https://docs.acmekit.com/learn/fundamentals/custom-cli-scripts/seed-data) or in a custom import script.
 * 
 * @example
