...
import { ProductVariantDTO } from "@acmekit/types"
import {
 ...
 * It's used by the [Batch Variant Images Admin API Route](https://docs.acmekit.com/api/admin#products_postproductsidvariantsvariant_idimagesbatch).
 *
