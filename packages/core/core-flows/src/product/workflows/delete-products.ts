import { Modules, ProductWorkflowEvents } from "@acmekit/framework/utils"
import {
  WorkflowData,
  WorkflowResponse,
  createHook,
 ...
 * [Delete Products Admin API Route](https://docs.acmekit.com/api/admin#products_deleteproductsid).
 *
