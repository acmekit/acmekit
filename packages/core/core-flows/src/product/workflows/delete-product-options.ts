import { Modules, ProductOptionWorkflowEvents } from "@acmekit/framework/utils"
import {
  WorkflowData,
  WorkflowResponse,
  createHook,
 ...
 * [Delete Product Option Admin API Route](https://docs.acmekit.com/api/admin#products_deleteproductsidoptionsoption_id).
 *
