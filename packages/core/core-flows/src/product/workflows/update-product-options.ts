import type { AdditionalData, ProductTypes } from "@acmekit/framework/types"
import { ProductOptionWorkflowEvents } from "@acmekit/framework/utils"
import {
  WorkflowData,
  WorkflowResponse,
  createHook,
...
/**
 * This workflow updates one or more product options. It's used by the [Update Product Option Admin API Route](https://docs.acmekit.com/api/admin#products_postproductsidvariantsvariant_id).
 *
