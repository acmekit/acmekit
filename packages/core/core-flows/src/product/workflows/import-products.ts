 ...
 * :::tip
 *
 * This example API route uses the same implementation as the [Confirm Product Import Admin API Route](https://docs.acmekit.com/api/admin#products_postproductsimporttransaction_idconfirm).
 *
 * :::
 *
 * @summary
