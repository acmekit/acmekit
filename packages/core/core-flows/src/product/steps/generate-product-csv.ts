...
export type GenerateProductCsvStepOutput = {
  /**
   * The ID of the generated file as returned by the [File Module Provider](https://docs.acmekit.com/resources/infrastructure-modules/file).
   */
  id: string
  /**
   * The name of the generated file as returned by the [File Module Provider](https://docs.acmekit.com/resources/infrastructure-modules/file).
   */
  filename: string
}
 ...
 * file is created and stored using the registered [File Module Provider](https://docs.acmekit.com/resources/infrastructure-modules/file).
 *
 * @example
