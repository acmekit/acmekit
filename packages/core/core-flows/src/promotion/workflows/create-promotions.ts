...
/**
 * This workflow creates one or more promotions. It's used by the [Create Promotion Admin API Route](https://docs.acmekit.com/api/admin#promotions_postpromotions).
 *
