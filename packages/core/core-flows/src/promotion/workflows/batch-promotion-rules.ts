 ...
 * [Manage Promotion Rules Admin API Route](https://docs.acmekit.com/api/admin#promotions_postpromotionsidrulesbatch),
 * [Manage Promotion Buy Rules Admin API Route](https://docs.acmekit.com/api/admin#promotions_postpromotionsidbuyrulesbatch),
 * and [Manage Promotion Target Rules Admin API Route](https://docs.acmekit.com/api/admin#promotions_postpromotionsidtargetrulesbatch).
 * 
