...
/**
 * This workflow updates one or more campaigns. It's used by the [Update Campaign Admin API Route](https://docs.acmekit.com/api/admin#campaigns_postcampaignsid).
 *
