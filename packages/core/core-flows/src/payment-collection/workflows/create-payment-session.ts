...
import { isPresent, Modules } from "@acmekit/framework/utils"
import {
  createWorkflow,
  parallelize,
  transform,
...
export interface CreatePaymentSessionsWorkflowInput {
   ...
   * Learn more in [this documentation](https://docs.acmekit.com/resources/commerce-modules/payment/payment-session#data-property).
   */
 ...
 * [Initialize Payment Session Store API Route](https://docs.acmekit.com/api/store#payment-collections_postpaymentcollectionsidpaymentsessions).
 *
