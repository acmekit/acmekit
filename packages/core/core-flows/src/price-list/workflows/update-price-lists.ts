import type { UpdatePriceListWorkflowInputDTO } from "@acmekit/framework/types"
 ...
 * [Update Price List Admin API Route](https://docs.acmekit.com/api/admin#price-lists_postpricelistsid).
 *
