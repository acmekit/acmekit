import { Modules, SalesChannelWorkflowEvents } from "@acmekit/framework/utils"
import {
  createWorkflow,
  transform,
  WorkflowData,
 ...
 * [Delete Sales Channel Admin API Route](https://docs.acmekit.com/api/admin#sales-channels_deletesaleschannelsid).
 * 
