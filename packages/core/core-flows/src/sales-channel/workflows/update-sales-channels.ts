...
import { SalesChannelWorkflowEvents } from "@acmekit/framework/utils"
import {
  WorkflowData,
  WorkflowResponse,
  createWorkflow,
 ...
 * [Update Sales Channel Admin API Route](https://docs.acmekit.com/api/admin#sales-channels_postsaleschannelsid).
 * 
