import type { OrderDTO, OrderWorkflow } from "@acmekit/framework/types"
import {
  WorkflowData,
  WorkflowResponse,
  createStep,
...
import type { CustomerDTO, OrderPreviewDTO } from "@acmekit/framework/types"
 ...
 * :::note
 *
 * You can retrieve an order and customer details using [Query](https://docs.acmekit.com/learn/fundamentals/module-links/query),
 ...
 *
 * This workflow is used by the [Request Order Transfer Store API Route](https://docs.acmekit.com/api/store#orders_postordersidtransferrequest),
 * and the [Request Order Transfer Admin API Route](https://docs.acmekit.com/api/admin#orders_postordersidtransfer).
 *
