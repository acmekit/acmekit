 ...
 * :::note
 *
 * You can retrieve an order and order change details using [Query](https://docs.acmekit.com/learn/fundamentals/module-links/query),
 ...
 * [Add Shipping Method API Route](https://docs.acmekit.com/api/admin#order-edits_postordereditsidshippingmethod).
 *
 ...
 *
 * ```ts
 * import { createOrderEditShippingMethodWorkflow } from "@acmekit/acmekit/core-flows";
