 ...
 * :::note
 *
 * You can retrieve an order change details using [Query](https://docs.acmekit.com/learn/fundamentals/module-links/query),
 ...
 * [Update Shipping Method Admin API Route](https://docs.acmekit.com/api/admin#order-edits_postordereditsidshippingmethodaction_id).
 *
 ...
 *
 * ```ts
 * import { updateOrderEditShippingMethodWorkflow } from "@acmekit/acmekit/core-flows";
