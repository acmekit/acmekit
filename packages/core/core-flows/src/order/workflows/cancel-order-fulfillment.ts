 ...
 * :::note
 *
 * You can retrieve an order and fulfillment details using [Query](https://docs.acmekit.com/learn/fundamentals/module-links/query),
...
/**
 * This workflow cancels an order's fulfillment. It's used by the [Cancel Order's Fulfillment Admin API Route](https://docs.acmekit.com/api/admin#orders_postordersidfulfillmentsfulfillment_idcancel).
 *
