import type { OrderDetailDTO, OrderDTO } from "@acmekit/framework/types"
import { deduplicate } from "@acmekit/framework/utils"
import {
  createWorkflow,
  transform,
  WorkflowData,
...
export type GetOrdersListWorkflowInput = {
   ...
   * are passed to [Query](https://docs.acmekit.com/learn/fundamentals/module-links/query),
 ...
 * [List Orders Admin API Route](https://docs.acmekit.com/api/admin#orders_getorders), and the
 * [List Orders Store API Route](https://docs.acmekit.com/api/store#orders_getorders).
 *
