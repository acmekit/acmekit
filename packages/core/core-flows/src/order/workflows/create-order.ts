import type { AdditionalData, CreateOrderDTO } from "@acmekit/framework/types"
import {
  PromotionActions,
  deduplicate,
  isDefined,
...
/**
 * This workflow creates an order. It's used by the [Create Draft Order Admin API Route](https://docs.acmekit.com/api/admin#draft-orders_postdraftorders), but
 ...
 * you can create a workflow that imports orders from an external system, then uses this workflow to create the orders in AcmeKit.
 *
 * @example
 ...
 *
 * ```ts
 * import { createOrderWorkflow } from "@acmekit/acmekit/core-flows";
