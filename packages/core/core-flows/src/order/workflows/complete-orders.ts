...
import { OrderWorkflowEvents } from "@acmekit/framework/utils"
import {
  WorkflowData,
  WorkflowResponse,
  createHook,
...
/**
 * This workflow marks one or more orders as completed. It's used by the [Complete Cart Admin API Route](https://docs.acmekit.com/api/admin#orders_postordersidcomplete).
 *
