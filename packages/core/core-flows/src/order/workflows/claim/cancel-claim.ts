 ...
 * :::note
 *
 * You can retrieve an order claim's details using [Query](https://docs.acmekit.com/learn/fundamentals/module-links/query),
 ...
 * [Cancel Claim API Route](https://docs.acmekit.com/api/admin#claims_postclaimsidcancel).
 *
