 ...
 * :::note
 *
 * You can retrieve an order, order claim, and order change details using [Query](https://docs.acmekit.com/learn/fundamentals/module-links/query),
 ...
 * It's used by the [Add Inbound Shipping Admin API Route](https://docs.acmekit.com/api/admin#claims_postclaimsidinboundshippingmethod),
 * and the [Add Outbound Shipping Admin API Route](https://docs.acmekit.com/api/admin#claims_postclaimsidoutboundshippingmethod).
 *
