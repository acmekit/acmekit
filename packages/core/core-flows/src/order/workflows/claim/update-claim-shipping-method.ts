 ...
 * :::note
 *
 * You can retrieve an order claim and order change details using [Query](https://docs.acmekit.com/learn/fundamentals/module-links/query),
 ...
 * It's used by the [Update Inbound Shipping Admin API Route](https://docs.acmekit.com/api/admin#claims_postclaimsidinboundshippingmethodaction_id),
 * and the [Update Outbound Shipping Admin API Route](https://docs.acmekit.com/api/admin#claims_postclaimsidoutboundshippingmethodaction_id).
 *
 ...
 * 
 * ```ts
 * import { updateClaimShippingMethodWorkflow } from "@acmekit/acmekit/core-flows";
