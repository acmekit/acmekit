 ...
 * :::note
 *
 * You can retrieve an order exchange's details using [Query](https://docs.acmekit.com/learn/fundamentals/module-links/query),
 ...
 * [Cancel Exchange Admin API Route](https://docs.acmekit.com/api/admin#exchanges_postexchangesidcancel).
 *
