...
import { ChangeActionType, OrderChangeStatus } from "@acmekit/framework/utils"
import {
  WorkflowData,
  WorkflowResponse,
  createHook,
 ...
 * :::note
 *
 * You can retrieve an order exchange and order change details using [Query](https://docs.acmekit.com/learn/fundamentals/module-links/query),
 ...
 * [Update Inbound Shipping Admin API Route](https://docs.acmekit.com/api/admin#exchanges_postexchangesidinboundshippingmethodaction_id)
 * or the [Outbound Inbound Shipping Admin API Route](https://docs.acmekit.com/api/admin#exchanges_postexchangesidoutboundshippingmethodaction_id).
 *
 ...
 * 
 * ```ts
 * import { updateExchangeShippingMethodWorkflow } from "@acmekit/acmekit/core-flows";
 * import { StepResponse } from "@acmekit/workflows-sdk";
 * 
 ...
 * :::note
 * 
 * Learn more about prices calculation context in the [Prices Calculation](https://docs.acmekit.com/resources/commerce-modules/pricing/price-calculation) documentation.
 * 
 * :::
 */
