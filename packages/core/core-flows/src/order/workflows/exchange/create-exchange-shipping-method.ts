 ...
 * :::note
 *
 * You can retrieve an order, order exchange, and order change details using [Query](https://docs.acmekit.com/learn/fundamentals/module-links/query),
 ...
 * It's used by the [Add Inbound Shipping Admin API Route](https://docs.acmekit.com/api/admin#exchanges_postexchangesidinboundshippingmethod)
 * and the [Add Outbound Shipping Admin API Route](https://docs.acmekit.com/api/admin#exchanges_postexchangesidoutboundshippingmethod).
 *
