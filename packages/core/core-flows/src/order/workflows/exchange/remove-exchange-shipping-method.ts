 ...
 * [Remove Inbound Shipping Admin API Route](https://docs.acmekit.com/api/admin#exchanges_deleteexchangesidinboundshippingmethodaction_id) or
 * the [Remove Outbound Shipping Admin API Route](https://docs.acmekit.com/api/admin#exchanges_deleteexchangesidoutboundshippingmethodaction_id).
 * 
