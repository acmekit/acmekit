 ...
 * :::note
 *
 * You can retrieve an order and fulfillment's details using [Query](https://docs.acmekit.com/learn/fundamentals/module-links/query),
 ...
 * [Mark Fulfillment as Delivered Admin API Route](https://docs.acmekit.com/api/admin#orders_postordersidfulfillmentsfulfillment_idmarkasdelivered).
 *
