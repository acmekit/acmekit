import type { PaymentCollectionDTO } from "@acmekit/framework/types"
 ...
 * :::note
 *
 * You can retrieve a payment collection's details using [Query](https://docs.acmekit.com/learn/fundamentals/module-links/query),
 ...
 * [Mark Payment Collection as Paid Admin API Route](https://docs.acmekit.com/api/admin#payment-collections_postpaymentcollectionsidmarkaspaid).
 *
