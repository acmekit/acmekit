import type { OrderDetailDTO } from "@acmekit/framework/types"
 ...
 * [Get an Order Admin API Route](https://docs.acmekit.com/api/admin#orders_getordersid), and
 * [Get an Order Store API Route](https://docs.acmekit.com/api/store#orders_getordersid).
 *
