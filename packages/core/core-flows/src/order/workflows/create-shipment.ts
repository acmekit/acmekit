 ...
 * :::note
 *
 * You can retrieve an order's details using [Query](https://docs.acmekit.com/learn/fundamentals/module-links/query),
...
/**
 * This workflow creates a shipment for an order. It's used by the [Create Order Shipment Admin API Route](https://docs.acmekit.com/api/admin#orders_postordersidfulfillmentsfulfillment_idshipments).
 *
