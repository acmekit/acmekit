 ...
 * :::note
 *
 * You can retrieve a return and order change details using [Query](https://docs.acmekit.com/learn/fundamentals/module-links/query),
 ...
 * [Update Shipping Method Admin API Route](https://docs.acmekit.com/api/admin#returns_postreturnsidshippingmethodaction_id).
 *
 ...
 * 
 * ```ts
 * import { updateReturnShippingMethodWorkflow } from "@acmekit/acmekit/core-flows";
