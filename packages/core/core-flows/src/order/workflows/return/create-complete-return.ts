 ...
 * :::note
 *
 * You can retrieve an order details using [Query](https://docs.acmekit.com/learn/fundamentals/module-links/query),
 ...
 * [Create Return Store API Route](https://docs.acmekit.com/api/store#return_postreturn).
 *
 ...
 *
 * ```ts
 * import { createAndCompleteReturnOrderWorkflow } from "@acmekit/acmekit/core-flows";
