 ...
 * :::note
 *
 * You can retrieve an order, order change, and return details using [Query](https://docs.acmekit.com/learn/fundamentals/module-links/query),
 ...
 * [Confirm Return Request Admin API Route](https://docs.acmekit.com/api/admin#returns_postreturnsidrequest).
 *
