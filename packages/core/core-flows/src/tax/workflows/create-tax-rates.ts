import type { CreateTaxRateDTO, TaxRateDTO } from "@acmekit/framework/types"
import {
  WorkflowData,
  WorkflowResponse,
  createWorkflow,
 ...
 * [Create Tax Rates Admin API Route](https://docs.acmekit.com/api/admin#tax-rates_posttaxrates).
 *
