...
import { ShippingOptionTypeWorkflowEvents } from "@acmekit/framework/utils"
import {
  createHook,
  createWorkflow,
  transform,
 ...
 * [Update Shipping Option Type Admin API Route](https://docs.acmekit.com/api/admin#shipping-option-types_postshippingoptiontypesid).
 *
