import type { FulfillmentWorkflow } from "@acmekit/framework/types"
import {
  createWorkflow,
  parallelize,
  transform,
...
import { ShippingOptionWorkflowEvents } from "@acmekit/framework/utils"
 ...
 * [Create Shipping Option Admin API Route](https://docs.acmekit.com/api/admin#shipping-options_postshippingoptions).
 *
 ...
 * :::note
 *
 * You can calculate the shipping option's price for a cart using the [calculateShippingOptionsPricesWorkflow](https://docs.acmekit.com/resources/references/acmekit-workflows/calculateShippingOptionsPricesWorkflow).
 *
 * :::
 *
 * ```ts
