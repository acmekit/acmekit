import type { FulfillmentDTO } from "@acmekit/framework/types"
 ...
 * :::note
 *
 * You can retrieve a fulfillment's details using [Query](https://docs.acmekit.com/learn/fundamentals/module-links/query),
