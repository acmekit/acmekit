...
import type { InventoryTypes } from "@acmekit/framework/types"
 ...
 * [Update an Inventory Item Admin API Route](https://docs.acmekit.com/api/admin#inventory-items_postinventoryitemsid).
 *
