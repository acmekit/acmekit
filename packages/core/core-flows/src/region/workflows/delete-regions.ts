import { Modules, RegionWorkflowEvents } from "@acmekit/framework/utils"
import {
  WorkflowData,
  createWorkflow,
  transform,
 ...
 * [Delete Region Admin API Route](https://docs.acmekit.com/api/admin#regions_deleteregionsid).
 *
