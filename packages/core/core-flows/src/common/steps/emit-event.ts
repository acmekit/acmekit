...
/**
 * This step emits an event, which you can listen to in a [subscriber](https://docs.acmekit.com/learn/fundamentals/events-and-subscribers). You can pass data to the
