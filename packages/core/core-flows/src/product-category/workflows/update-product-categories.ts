...
import { ProductCategoryWorkflowEvents } from "@acmekit/framework/utils"
import {
  WorkflowData,
  WorkflowResponse,
  createWorkflow,
 ...
 * [Update Product Category Admin API Route](https://docs.acmekit.com/api/admin#product-categories_postproductcategoriesid).
 *
