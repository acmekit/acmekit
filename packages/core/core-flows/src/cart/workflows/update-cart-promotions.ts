import { PromotionActions } from "@acmekit/framework/utils"
import {
  createHook,
  createWorkflow,
  parallelize,
 ...
 * [Add Promotions Store API Route](https://docs.acmekit.com/api/store#carts_postcartsidpromotions).
 *
 ...
 *     cart_id: "cart_123",
 *     promo_codes: ["10OFF"],
 *     // imported from @acmekit/framework/utils
