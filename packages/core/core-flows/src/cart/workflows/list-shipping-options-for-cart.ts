 ...
 * [List Shipping Options Store API Route](https://docs.acmekit.com/api/store#shipping-options_getshippingoptions).
 *
 * :::note
 *
 ...
 *
 * ```ts
 * import { listShippingOptionsForCartWorkflow } from "@acmekit/acmekit/core-flows";
 ...
 *
 * ```ts
 * import { listShippingOptionsForCartWithPricingWorkflow } from "@acmekit/acmekit/core-flows"
 * import { StepResponse } from "@acmekit/workflows-sdk"
 *
