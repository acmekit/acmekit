 ...
 * [Complete Cart Store API Route](https://docs.acmekit.com/api/store#carts_postcartsidcomplete).
 *
 ...
 * For example, in the [Subscriptions recipe](https://docs.acmekit.com/resources/recipes/subscriptions/examples/standard#create-workflow),
 ...
 * [entry point of the link](https://docs.acmekit.com/learn/fundamentals/module-links/custom-columns#method-2-using-entry-point)
 ...
 * import { cancelOrderWorkflow } from "@acmekit/acmekit/core-flows"
 *
 * type StepInput = {
 *   order_id: string
 *   // other input fields...
 ...
 *   WorkflowResponse
 * } from "@acmekit/framework/workflows-sdk"
 * import { useQueryGraphStep } from "@acmekit/framework/workflows-sdk"
