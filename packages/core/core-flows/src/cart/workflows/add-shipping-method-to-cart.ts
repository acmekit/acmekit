import { CartWorkflowEvents, AcmeKitError } from "@acmekit/framework/utils"
import {
  createHook,
  createWorkflow,
  parallelize,
...
export interface AddShippingMethodToCartWorkflowInput {
  ...
  options: {
     ...
     *
     * Learn more in [this documentation](https://docs.acmekit.com/resources/commerce-modules/fulfillment/shipping-option#data-property).
     */
 ...
 * [Add Shipping Method Store API Route](https://docs.acmekit.com/api/store#carts_postcartsidshippingmethods).
 *
