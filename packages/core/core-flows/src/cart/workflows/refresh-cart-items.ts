import type { AdditionalData } from "@acmekit/framework/types"
import { isDefined, PromotionActions } from "@acmekit/framework/utils"
import {
  createHook,
  createWorkflow,
  transform,
 ...
 *
 * ```ts
 * import { refreshCartItemsWorkflow } from "@acmekit/acmekit/core-flows";
