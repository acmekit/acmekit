import { AcmeKitContainer, Query } from "@acmekit/framework"
import {
  CalculatedPriceSet,
...
export interface GetVariantPriceSetsStepInput {
   ...
   *
   * Learn more in [this documentation](https://docs.acmekit.com/resources/commerce-modules/product/guides/price#retrieve-calculated-price-for-a-context).
   */
