 ...
 * [Delete File Upload Admin API Route](https://docs.acmekit.com/api/admin#uploads_deleteuploadsid).
 * 
 * The [File Module Provider](https://docs.acmekit.com/resources/infrastructure-modules/file) installed
