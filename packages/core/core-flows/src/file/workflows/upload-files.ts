 ...
 * [File Module Provider](https://docs.acmekit.com/resources/infrastructure-modules/file). The workflow is used by the
 * [Upload Files Admin API Route](https://docs.acmekit.com/api/admin#uploads_postuploads).
 *
