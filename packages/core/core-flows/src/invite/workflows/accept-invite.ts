 ...
 * [Accept Invite Admin API Route](https://docs.acmekit.com/api/admin#invites_postinvitesaccept).
 *
 ...
 * using the [Retrieve Registration JWT Token API Route](https://docs.acmekit.com/api/admin#auth_postactor_typeauth_provider_register).
 *
