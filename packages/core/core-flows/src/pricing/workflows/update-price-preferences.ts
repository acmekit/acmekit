import type { PricingWorkflow } from "@acmekit/framework/types"
import {
  WorkflowData,
  WorkflowResponse,
  createWorkflow,
 ...
 * [Update Price Preference Admin API Route](https://docs.acmekit.com/api/admin#price-preferences_postpricepreferencesid).
 *
