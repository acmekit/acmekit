...
export interface ListLineItemsStepInput {
   ...
   * 
   * Learn more in the [service factory reference](https://docs.acmekit.com/resources/service-factory-reference/methods/list).
   */
 ...
 * ```
 * 
 * Learn more about listing items in [this service factory reference](https://docs.acmekit.com/resources/service-factory-reference/methods/list).
 */
