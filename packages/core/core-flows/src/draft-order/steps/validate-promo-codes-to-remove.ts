...
import type { PromotionDTO } from "@acmekit/framework/types"
 ...
 * :::note
 *
 * You can retrieve a promotion's details using [Query](https://docs.acmekit.com/learn/fundamentals/module-links/query),
