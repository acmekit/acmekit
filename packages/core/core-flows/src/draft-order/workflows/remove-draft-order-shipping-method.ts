...
import type { OrderChangeDTO, OrderDTO } from "@acmekit/framework/types"
 ...
 * [Remove Shipping Method from Draft Order Edit Admin API Route](https://docs.acmekit.com/api/admin#draft-orders_deletedraftordersideditshippingmethodsmethodmethod_id).
 *
