import type { BigNumberInput, PaymentDTO } from "@acmekit/framework/types"
import { isDefined, MathBN, AcmeKitError } from "@acmekit/framework/utils"
import {
  createStep,
  createWorkflow,
  transform,
 ...
 * :::note
 *
 * You can retrieve a payment's details using [Query](https://docs.acmekit.com/learn/fundamentals/module-links/query),
