import { BigNumberInput, PaymentDTO } from "@acmekit/framework/types"
import {
  BigNumber,
  MathBN,
  AcmeKitError,
 ...
 * [Refund Payment Admin API Route](https://docs.acmekit.com/api/admin#payments_postpaymentsidrefund).
 *
