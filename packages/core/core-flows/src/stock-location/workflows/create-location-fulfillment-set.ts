import type { CreateLocationFulfillmentSetWorkflowInputDTO } from "@acmekit/framework/types"
import {
  WorkflowData,
  createWorkflow,
  transform,
 ...
 * [Add Fulfillment Set to Stock Location Admin API Route](https://docs.acmekit.com/api/admin#stock-locations_poststocklocationsidfulfillmentsets).
 *
