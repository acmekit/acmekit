...
import type { CreateStockLocationInput } from "@acmekit/framework/types"
 ...
 * [Create Stock Location Admin API Route](https://docs.acmekit.com/api/admin#stock-locations_poststocklocations).
 *
