...
import { transform } from "@acmekit/framework/workflows-sdk"
import {
 ...
 * [Manage Sales Channels Admin API Route](https://docs.acmekit.com/api/admin#stock-locations_poststocklocationsidsaleschannels).
 *
