...
describe("loadDatabaseConfig", function () {
  ...
  it("should return the local configuration using the environment variable respecting their precedence", function () {
    process.env.MEDUSA_DATABASE_URL = "postgres://localhost:5432/acmekit"
  ...
  it("should return the remote configuration using the environment variable", function () {
    process.env.DATABASE_URL = "postgres://https://test.com:5432/acmekit"
    let config = loadDatabaseConfig("product")
    ...
    delete process.env.DATABASE_URL
    process.env.PRODUCT_DATABASE_URL = "postgres://https://test.com:5432/acmekit"
    config = loadDatabaseConfig("product")
  ...
  it("should return the local configuration using the options", function () {
    process.env.DATABASE_URL = "postgres://localhost:5432/acmekit"
    const options = {
      database: {
        clientUrl: "postgres://localhost:5432/acmekit-test",
      },
    }
  ...
  it("should return the local configuration using the options", function () {
    ...
    const options = {
      database: {
        clientUrl: "postgres://127.0.0.1:5432/acmekit-test",
      },
    }
  ...
  it("should return the remote configuration using the options", function () {
    ...
    const options = {
      database: {
        clientUrl: "postgres://https://test.com:5432/acmekit-test",
      },
    }
  ...
  it("should return the local configuration using the client url ssl_mode=disable", function () {
    ...
    const options = {
      database: {
        clientUrl:
          "postgres://https://test.com:5432/acmekit-test?ssl_mode=disable",
      },
    }
  ...
  it("should return the local configuration using the client url sslmode=disable", function () {
    ...
    const options = {
      database: {
        clientUrl:
          "postgres://https://test.com:5432/acmekit-test?sslmode=disable",
      },
    }
    ...
    expect(config).toEqual({
      clientUrl: "postgres://https://test.com:5432/acmekit-test?sslmode=disable",
      driverOptions: {
        connection: {
          ssl: false,
        },
  ...
  it("should return the remote configuration using the client url ssl_mode=false", function () {
    ...
    const options = {
      database: {
        clientUrl:
          "postgres://https://test.com:5432/acmekit-test?ssl_mode=false",
      },
    }
