...
export function defineLink(
  ...
  const register = function (
    ...
    if (!serviceAInfo) {
      throw new Error(`Service ${serviceAObj.module} was not found. If this is your module, make sure you set isQueryable to true in acmekit-config.js:
...
${serviceAObj.module}: {
  ...
  definition: {
    ...
    if (!serviceBInfo) {
      throw new Error(`Service ${serviceBObj.module} was not found. If this is your module, make sure you set isQueryable to true in acmekit-config.js:
