...
import { AcmeKitMikroOrmEventSubscriber } from "./create-acmekit-mikro-orm-event-subscriber"

type InternalService = {
  new <TContainer extends object = object, TEntity extends object = any>(
    container: TContainer
  ): ModulesSdkTypes.IAcmeKitInternalService<TEntity, TContainer>
...
/**
 * Check if a value is a AcmeKit internal service
 * @param value
 */
export function isAcmeKitInternalService(value: any): value is InternalService {
  return (
...
>(rawModel: any): InternalService {
  ...
  class AbstractService_
    implements ModulesSdkTypes.IAcmeKitInternalService<TEntity, TContainer>
  {
