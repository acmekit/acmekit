...
export class AbstractAnalyticsProviderService implements IAnalyticsProvider {
   ...
   * will use this method in its `track` method if your provider is configured in `acmekit-config.ts`.
   * 
   ...
   * will use this method in its `identify` method if your provider is configured in `acmekit-config.ts`.
   *
