  ...
  implements IPaymentProvider
{
   ...
   * 
   * ![Diagram showcasing capture payment flow](https://res.cloudinary.com/dza7lstvk/image/upload/v1747307414/AcmeKit%20Resources/Klarna_Payment_Graphic_2025_1_lii7bw.jpg)
   * 
   ...
   * 
   * ![Diagram showcasing data flow between methods](https://res.cloudinary.com/dza7lstvk/image/upload/v1747309870/AcmeKit%20Resources/capture-data_acgdhf.jpg)
   *
   ...
   * 
   * ![Diagram showcasing authorize payment flow](https://res.cloudinary.com/dza7lstvk/image/upload/v1747307795/AcmeKit%20Resources/authorize-payment_qzpy6e.jpg)
   * 
   ...
   * For example, you can store the ID of the payment in the third-party provider to reference it later.
   * 
   * ![Diagram showcasing data flow between methods](https://res.cloudinary.com/dza7lstvk/image/upload/v1747309278/AcmeKit%20Resources/authorize-data_erjg7r.jpg)
   *
   ...
   * 
   * ![Diagram showcasing data flow between methods](https://res.cloudinary.com/dza7lstvk/image/upload/v1747310189/AcmeKit%20Resources/cancel-data_gzcgbc.jpg)
   *
   ...
   * 
   * ![Diagram showcasing initiate payment flow](https://res.cloudinary.com/dza7lstvk/image/upload/v1747310624/AcmeKit%20Resources/initiate-payment_dpoa2g.jpg)
   * 
   * #### Understanding `data` property
   * 
   ...
   * :::
   * 
   * ![Diagram showcasing data flow between methods](https://res.cloudinary.com/dza7lstvk/image/upload/v1747310699/AcmeKit%20Resources/initiate-data_ikc05t.jpg)
   *
   ...
   * 
   * ![Diagram showcasing delete payment flow](https://res.cloudinary.com/dza7lstvk/image/upload/v1747311084/AcmeKit%20Resources/delete-payment_smxsiq.jpg)
   * 
   * #### Understanding `data` property
   * 
   * The `data` property of the method's parameter contains the `PaymentSession` record's `data` property, which was
   * returned by the {@link initiatePayment} method.
   * 
   * ![Diagram showcasing data flow between methods](https://res.cloudinary.com/dza7lstvk/image/upload/v1747311084/AcmeKit%20Resources/delete-data_xg65ck.jpg)
   *
   ...
   * :::
   * 
   * ![Diagram showcasing data flow between methods](https://res.cloudinary.com/dza7lstvk/image/upload/v1747311296/AcmeKit%20Resources/refund-data_plcjl0.jpg)
   *
