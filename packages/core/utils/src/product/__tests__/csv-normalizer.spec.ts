    ...
    expect(products).toMatchInlineSnapshot(`
      {
        "toCreate": {
          "sweatshirt": {
            ...
            "status": "published",
            "thumbnail": "https://acmekit-public-images.s3.eu-west-1.amazonaws.com/sweatshirt-vintage-front.png",
    ...
    expect(products).toMatchInlineSnapshot(`
      {
        "toCreate": {
          "shorts": {
            ...
            "status": "published",
            "thumbnail": "https://acmekit-public-images.s3.eu-west-1.amazonaws.com/shorts-vintage-front.png",
          ...
          "sweatpants": {
            ...
            "status": "published",
            "thumbnail": "https://acmekit-public-images.s3.eu-west-1.amazonaws.com/sweatpants-gray-front.png",
          ...
          "t-shirt": {
            ...
            "status": "published",
            "thumbnail": "https://acmekit-public-images.s3.eu-west-1.amazonaws.com/tee-black-front.png",
        ...
        "toUpdate": {
          ...
          "prod_01JT598HEWAE555V0A6BD602MG": {
            ...
            "images": [
              {
                "url": "https://acmekit-public-images.s3.eu-west-1.amazonaws.com/coffee-mug.png",
              },
            ],
            "options": [
              {
            ...
            "sales_channels": [],
            "status": "published",
            "thumbnail": "https://acmekit-public-images.s3.eu-west-1.amazonaws.com/coffee-mug.png",
            "title": "AcmeKit Coffee Mug",
            "variants": [
              {
                "allow_backorder": false,
