import { BigNumberInput, BigNumberRawValue } from "@acmekit/types"
...
export class MathBN {
  static convert(num: BNInput, decimalPlaces?: number): BigNumberJS {
    ...
    let num_: BigNumberJS
    if (num instanceof BigNumber) {
      num_ = num.bigNumber ?? new BigNumberJS(num.numeric)
      ...
      num_ = new BigNumberJS(num as number | string)
    }
